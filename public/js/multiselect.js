...
!function($) {"use strict";// jshint ;_;
    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            // option is selected, or a list of the selected options up to a length of 2 selected options.
            // If more than 2 options are selected, the number of selected options is printed.
            ...
            nonSelectedText: 'Search by Country',
        ...
        createOptionValue: function(element) {
            ...
            var $li = $('<li class="col-md-12"><a href="javascript:void(0);"><label class="' + inputType + '"><input type="' + inputType + '" /></label></a></li>');
        ...
        buildDropdown: function() {
            ...
            this.$select.children().each($.proxy(function(index, element) {
                ...
                if (tag == 'optgroup') {
                    ...
                    var $li = $('<li class="col-md-4"><label class="multiselect-group"></label></li>');
            ...
            this.$container.on('keydown', $.proxy(function(event) {
                ...
                if ((event.keyCode == 9 || event.keyCode == 27) && this.$container.hasClass('open')) {
                    ...
                    if (this.options.selectedClass == "active col-md-4") {
