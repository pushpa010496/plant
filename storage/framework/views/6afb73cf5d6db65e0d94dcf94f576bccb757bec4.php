		...
		<div class="row">
			...
			<div class="col-6  my-auto pb-2 text-right gray-text align-self-center">
				<p class="mb-0">
					...
					<img src="<?php echo e(config('app.url')); ?>webinars/iiot/industrial-iot-ai-virtual-series-logo-3.png"
	...
	<div class="container" style='margin-top:140px;'>
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mt-2 text-center">
				<img src="<?php echo e(config('app.url')); ?>webinars/iiot/industrial-iot-ai-virtual-series-banner-6.jpg" alt="PSI-Webinar" title="PSI-Webinar" class="img-fluid shadow" />
			</div>

			<div class="col-lg-7 col-md-7 col-sm-12 col-12">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-12 pt-3">
						<h2 class="font-weight-bold PF-TXTRED font-20">Creating a prototype additive manufacturing supply chain including a cyber secure digital transport system </h2>

						<p class="font-weight-bold">Dr. Dean Bartles will provide an overview of a prototype system that enables the transmission of 3D models directly to the additive manufacturing supply chain and the collection of in-process data which is transmitted back to the customer via the same system when the parts are shipped.</p>
			...
			<div class="col-lg-5 col-md-5 col-sm-12 col-12 mt-3">
				<img type="button" data-toggle="modal" data-target="#videoFormModal" src="<?php echo e(config('app.url')); ?>webinars/iiot/mtdg-video.png" alt="PSI Webinar" title="PSI Webinar" class="img-fluid video shadow border text-center" />
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="p-2 PF-BrdrDDD mb-3 bg-white shadow">
					<div class="row">
						...
						<img src="<?php echo e(config('app.url')); ?>webinars/iiot/industrial-iot-ai-virtual-series-speaker-3.jpg" alt="Katarzyna Moscicka" title="Katarzyna Moscicka" class="img-fluid">
						</div>
						<div class="col-lg-10 col-md-10 col-sm-12 col-12">
							<h2 class="TXT-RED mt-2 mb-1"><strong>Dr. Dean L. Bartles</strong></h2>
							<p class="gray-text mb-2"><em>Chief Executive Officer & President</em></p>
							<p class="mb-1">Dr. Dean L. Bartles is the President and Chief Executive Officer of the Manufacturing Technology Deployment Group which includes the National Center for Defense Manufacturing and Machining and Advanced Manufacturing International, Inc. Previously, he was President of the National Tooling and Machining Association. Prior to that he designed and built the John Olson Advanced Manufacturing Center at the University of New Hampshire. Dr. Bartles was the founding Executive Director of the Digital Manufacturing and Design Innovation Institute in Chicago after working for General Dynamics Corporation for 30 years setting up manufacturing operations in Egypt, Turkey, and the US. He recently served as the 2016-2017 President of the North American Manufacturing Research Institute, 2016 President of the Society of Manufacturing Engineers, and founding Chairman of the Smart Manufacturing Leadership Coalition. Dr. Bartles graduated from Indiana State University earning a Ph. D. in Technology Management with a concentration in Manufacturing Systems.</p>
		...
		<div class="modal-dialog modal-md">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="<?php echo e(route('mtdg.post')); ?>" method="post" id='writemessage' >
...
<?php /**PATH /home/plantautomationt/public_html/resources/views/webinars/mtdg/index.blade.php ENDPATH**/ ?>