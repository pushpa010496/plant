...
<style>
  ...
  .advert-bg{
    background-image: url("<?php echo e(config('app.url')); ?>img/advertise/advertise-bg.jpg");
              ...
              <div class="row min-hyt-580">
                <div class="col-lg-5 pt-3 pl-5">
                  ...
                  <ul class="pl-0">
                    ...
                    <li><img src="<?php echo e(config('app.url')); ?>img/advertise/hand-icon.png" alt="Hand icon" width="20" class="mr-3" /> Company Profile
                    </li>
                    <li><img src="<?php echo e(config('app.url')); ?>img/advertise/hand-icon.png" alt="Hand icon" width="20" class="mr-3" /> Banner Advertisements
                    </li>
                    <li><img src="<?php echo e(config('app.url')); ?>img/advertise/hand-icon.png" alt="Hand icon" width="20" class="mr-3" /> e-Mail Direct Marketing
                    </li>
                    <li><img src="<?php echo e(config('app.url')); ?>img/advertise/hand-icon.png" alt="Hand icon" width="20" class="mr-3" /> e-Newsletter
                    </li>
                    <li><img src="<?php echo e(config('app.url')); ?>img/advertise/hand-icon.png" alt="Hand icon" width="20" class="mr-3" /> Video Marketing
                    </li>
                    <li><img src="<?php echo e(config('app.url')); ?>img/advertise/hand-icon.png" alt="Hand icon" width="20" class="mr-3" /> Digital Marketing
                    </li>
                  </ul>
                </div>

                <div class="col-lg-7">
                  <img src="<?php echo e(config('app.url')); ?>img/advertise/advertise-user.png" alt="" class="img-fluid banner-wrap-img" />
                </div>
              </div>
            </div> 
            ...
            <div id="testimonial" class="carousel slide" data-ride="carousel"> 
              ...
              <div class="carousel-inner">
                ...
                <div class="carousel-item active text-center">
                  <img src="<?php echo config('app.url'); ?>testimonial/<?php echo $testimonial->image;?>" class="img-fluid rounded-circle mt-1 mb-1" alt="<?php echo e($testimonial->img_alt); ?>" title="<?php echo e($testimonial->img_title); ?>" />
                    <p class="discription"><?php echo e($testimonial->description); ?></p>
                    <p class="name"><strong><?php echo e($testimonial->client_name); ?></strong> - <?php echo e($testimonial->company_name); ?><br>
                    <small><?php echo e($testimonial->designation); ?></small></p>  
                </div>
                  <?php else: ?>
...
<?php echo $__env->make('../layouts/pages', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/plantautomationt/public_html/resources/views/forms/advertise.blade.php ENDPATH**/ ?>