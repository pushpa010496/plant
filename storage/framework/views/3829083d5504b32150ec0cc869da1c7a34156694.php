        ...
        <div class="row">
            <div class="col-lg-9">           
             <?php $__currentLoopData = $brochures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <a target="_blank" href="<?php echo e(config('app.url')); ?>event/organiser/brochure/<?php echo e($cp->pdf); ?>"><img class="img-fluid div-scal" src="<?php echo e(config('app.url')); ?>event/organiser/brochure/<?php echo e($cp->image); ?>" alt="<?php echo e($cp->img_alt); ?>"></a>
              </div>
              ...
              <div class="bg-white p-2 border border-secondary"> 
                ...
                <?php echo Form::open(['url' => 'company-enquiry']); ?>
                  ...
                  <div class="form-group">
                    ...
                    <input type="hidden" name="page" value="event brochure">
...
<?php echo $__env->make('../layouts/eventorg', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/plantautomationt/public_html/resources/views/eventorg/brochures.blade.php ENDPATH**/ ?>