        ...
        <div class="col-lg-9">
            ...
            <div class="mb-3">
                ...
                <span
                    ...
                    class="bg-primary pl-4 pr-4 pt-1 pb-1 text-white mb-0 font-weight-bold font-20"><?php echo e($val->series_title); ?></span>
                ...
                <div class="p-2 bg-light border">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-12 text-center align-self-center">
                            ...
                            <img src="<?php echo e(config('app.url').'/webinars/'. $val->image); ?>" alt="<?php echo e($val->alt_tag); ?>"

                                title="<?php echo e($val->alt_tag); ?>" class="img-fluid" />
                        ...
                        <div class="col-lg-9 col-12">
                            ...
                            <h2 class="mt-1 font-18">
                                ...
                                <a href="<?php echo e(url($val->url)); ?>" title="<?php echo $val->title_tag; ?>" class="PF-TXTRED"

                                    target="_blank"><?php echo $val->title; ?></a>
                            ...
                            <div class="text-left">
                                ...
                                <a href="<?php echo e($val->china_url); ?>" target="_blank"

                                    class="btn btn-sm btn-danger"><?php echo e(@$val->china_title); ?></a>

                                <span class="p-1"></span>

                                <a href="<?php echo e($val->korea_url); ?>" target="_blank"

                                    class="btn btn-sm btn-danger"><?php echo e(@$val->korea_title); ?></a>
            ...
            <?php if($val->webinar_date <= Carbon\Carbon::today()): ?> <?php if($completed_flag==false): ?> 
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-12">
                        ...
                        <h2 class="mt-1 font-18">
                            ...
                            <a href="<?php echo e(url($val->url)); ?>" title="<?php echo e($val->title_tag); ?>" class="PF-TXTRED"

                                target="_blank"><?php echo e($val->title); ?></a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('../layouts/pages', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/plantautomationt/public_html/resources/views/webinars/index.blade.php ENDPATH**/ ?>