 ...
 <!-- // Profile Body -->
      <div class="container pt-4 pb-3">
        <div class="row">
            <div class="col-lg-9">    
             <div class="row">       
             <?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>             
              <div class="col-lg-4 text-center mb-4">
                <a href="#"><img class="img-fluid div-scal" src="<?php echo e(config('app.url').'event/organiser/article/'.$cp->image); ?>" alt=""></a>
              </div>            
              ...
              <div class="bg-white p-2 border border-secondary"> 
                ...
                <?php echo Form::open(['url' => 'company-enquiry']); ?>
                  ...
                  <div class="form-group">
                    ...
                    <input type="hidden" name="page" value="Event Organiser Articles">
...
<?php echo $__env->make('../layouts/eventorg', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/plantautomationt/public_html/resources/views/eventorg/articles.blade.php ENDPATH**/ ?>