      ...
      <div class="row">
        ...
        <div class="col-lg-6 form-bg-color">
          <!--  <center> <?php echo $__env->make('error', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?></center>    -->
            ...
            <div class="mt-4"></div>  
            <?php echo Form::open(['url' => 'newsletter-signup-success','class'=>'contact-form d-flex justify-content-center']); ?>

              <div class="form-container"> 
                <h1 class="form-title CAPS text-center">Newsletter Signup</h1> 
                ...
                <div class="input-container"> 
                  ...
                  <div class="row input-group req-input"> 
                    <?php echo e(Form::textarea('message', null,['placeholder'=>'Your Message ...','rows'=>5])); ?>
                      ...
                      <div class="error text-danger"><?php echo e($errors->first('message')); ?></div>
                    <?php endif; ?>
                  </div> 
...
<?php echo $__env->make('../layouts/pages', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/plantautomationt/public_html/resources/views/forms/newslettersignup.blade.php ENDPATH**/ ?>