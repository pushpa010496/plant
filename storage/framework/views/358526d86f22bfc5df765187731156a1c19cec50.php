...
<head>
	...
	<title>Should I stay or should I go-The Transition of Manufacturing Areas Into the 21st Century</title>
	...
	<meta property="og:image" content="https://industry.plantautomation-technology.com/webinars/iiot/joachim-video.png" />
	...
	<meta property="og:url" content="<?php echo e(url('joachim-webinar')); ?>" />
		...
		<div class="row">
			...
			<div class="col-6  my-auto pb-2 text-right gray-text align-self-center">
				<p class="mb-0">
					...
					<img src="<?php echo e(config('app.url')); ?>webinars/iiot/industrial-iot-ai-virtual-series-logo-6.png"
	...
	<div class="container" style='margin-top:140px;'>
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mt-2 text-center">
				<img src="<?php echo e(config('app.url')); ?>webinars/iiot/industrial-iot-ai-virtual-series-banner-9.jpg" alt="PSI-Webinar" title="PSI-Webinar" class="img-fluid shadow" />
			</div>

			<div class="col-lg-7 col-md-7 col-sm-12 col-12">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-12 pt-3">
						<h2 class="font-weight-bold PF-TXTRED font-20">Should I stay or should I go-The Transition of Manufacturing Areas Into the 21st Century 	 </h2>

						<p class="font-weight-bold">The world is getting faster every day and that puts a lot of pressure on existing systems and people.</p>

						<p class="font-weight-bold">The apparel Industry has moved always, like a caravan to an ever-cheaper location. But that’s not what is at stake right now.</p>
<p class="font-weight-bold">Digitalization, Hyper-Personalization and Leadtime reduction are challenges that put every strategy, every tool and every metric of the past decades on fire. So how do we change not only our assets, our hardware, our factories, but also the mindset of our people. How can we make the whole system more agile and responsive, more flexible for a very unknown future which many summarize under VUCA. And can I maybe by-pass this, can I avoid changing my organization. What happens if I move and what if I don’t? Let’s have a look.</p>
			...
			<div class="col-lg-5 col-md-5 col-sm-12 col-12 mt-3">
				<img type="button" data-toggle="modal" data-target="#videoFormModal" src="<?php echo e(config('app.url')); ?>webinars/iiot/joachim-video.png" alt="PSI Webinar" title="PSI Webinar" class="img-fluid video shadow border text-center" />
				<div class="p-2 PF-BrdrDDD mb-1 bg-light shadow mt-4" align="center">
					<h3 class="pt-1 pb-1">
						<strong class="TXT-RED font-20">March 31, 2021</strong>
						<span class="small text-secondary ml-2 mr-3">(Tuesday)</span>
						<p class="mt-2 mb-0 font-weight-bold font-16">04:00 PM (IST)</p>
					</h3>						
				</div>
			</div>
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="p-2 PF-BrdrDDD mb-3 bg-white shadow">
					<div class="row">
						...
						<img src="<?php echo e(config('app.url')); ?>webinars/iiot/industrial-iot-ai-virtual-series-speaker-6.jpg" alt="Katarzyna Moscicka" title="Katarzyna Moscicka" class="img-fluid">
						</div>
						<div class="col-lg-10 col-md-10 col-sm-12 col-12">
							<h2 class="TXT-RED mt-2 mb-1"><strong>Joachim Hensch</strong></h2>
							<p class="gray-text mb-2"><em>Chief Transition Officer, Interim Manager & Mentor</em></p>
							<p class="mb-1">Joachim Hensch has a profound and holistic knowledge in garment manufacturing, technology and innovation. Starting as a tailor in bespoke couture, he then moved to the ready to wear business and has taken various positions in product development and production. In 2015 he became managing director in the Izmir factory of HUGO BOSS Group with 3800 employees.</p>

							<P>His mission was to transform the organization into a flexible and responsive Smart Factory with the means of industry 4.0. That, to be better prepared for a highly volatile, demanding and impatient market environment. Within this approach he is in the forefront of innovation excellence in garment manufacturing and thus the Izmir Factory is a role model today for the global apparel industry.</P>

							<P>He believes in agile, SCRUM based project execution and flat hierarchies to cope with today’s pace of doing business. In September 2020 he founded his own Consulting firm and thus helps manufacurers and Startups with their tranformation towards modern manufacturing methods and mindsets. He lives in Stuttgart, Germany.</P>
		...
		<div class="modal-dialog modal-md">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="<?php echo e(route('joachim.post')); ?>" method="post" id='writemessage' >
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group <?php echo e($errors->first('name', 'has-error')); ?>">
									...
									<input type="hidden" name="type" id="type" value="joachim" />
									<input type="hidden" name="formtype"  value="modal-form" />
									<input type="hidden" name="client_message" id="client_message" value="Thank you for your interest in the transition of manufacturing areas into the 21st century." />
							...
							<div class="col-md-12">
								<div class="form-group">
									<div class="custom-control custom-checkbox mb-1">
										...
										<label class="custom-control-label font-13" for="email_updates">I would like to receive email updates about the transition of manufacturing areas into the 21st century.</label>
									</div>
									<div class="custom-control custom-checkbox mb-1">
									...
									<div class="custom-control custom-checkbox mb-1">
										...
										<label class="custom-control-label font-13" for="representative">I have more questions and would like to be contacted by a transition of manufacturing areas into the 21st century  Webinar representative</label>
									</div>
								</div>
							</div>
...
<?php /**PATH /home/plantautomationt/public_html/resources/views/webinars/joachim/index.blade.php ENDPATH**/ ?>