      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-white div-shadow">
        <div class="container">
          <div class="col-lg-6 text-left">
            <img src="<?php echo e(config('app.url')); ?>/img/main-logo.png" height="50" class="d-inline-block" alt="Plant Automation Technology" />
          </div>
          <div class="col-lg-6 text-right">
            <img src="<?php echo e(config('app.url')); ?>single/img/cooper-corp-logo.png" height="70" class="d-inline-block" alt="CooperCorp" />
          </div> 
        </div>                         
      </nav>      
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <img src="<?php echo e(config('app.url')); ?>/img/main-logo.png" width="200" class="img-fluid" alt="Plant Automation Technology" />
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-5 pt-4 text-center">
            <img src="<?php echo e(config('app.url')); ?>single/img/cooper-generator.png" class="img-fluid" alt="CooperCorp Generator" />
          ...
          <div class="col-lg-4 pt-3 pb-3 text-center">
            <img src="<?php echo e(config('app.url')); ?>single/img/coopercorp-slid-2.jpg" class="img-fluid" alt="Cooper Bolt" />
          </div>

          <div class="col-lg-3 text-center">
            <div class="p-3 bg-white mt-3 mb-3">
              <h2 class="font-weight-bold display-5 pb-1 text-center">Enquire Now</h2>
              <form method="post" action="<?php echo e(url('coopercorp-industrial-power-generators')); ?>">
                <?php echo e(csrf_field()); ?>                  
                <input type="hidden" name="formtype" value="banner-form">

                <div class="form-group">
                  <input type="text" class="form-control" name="name" id="name" value="<?php echo e(old('name')); ?>" placeholder="Name*" required>
                ...
                <div class="form-group">
                  <input type="email" class="form-control" name="email" id="email" value="<?php echo e(old('email')); ?>" placeholder="E-mail Address*" required>
                ...
                <div class="form-group">
                  <input type="text" class="form-control" name="phone" id="phone"  value="<?php echo e(old('phone')); ?>" placeholder="Telephone*" required>
      ...
      <div class="border border-secondary p-3 bg-light mt-4">
        <div class="row">          
          <div class="col-lg-6 text-center">
            <img src="<?php echo e(config('app.url')); ?>single/img/quality.png" class="img-fluid pb-3" alt="Quality" width="80" />
          ...
          <div class="col-lg-6 text-center">
            <img src="<?php echo e(config('app.url')); ?>single/img/efficiency.png" class="img-fluid pb-3" alt="Efficiency" width="80" />
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="p-4 border border-secondary">
            <div class="text-center">
              <img src="<?php echo e(config('app.url')); ?>single/img/robust-reliable.png" class="img-fluid" alt="Robust & Reliable" />
            </div>
      ...
      <div class="row">
        <div class="col-lg-6 text-center">             
          <img src="<?php echo e(config('app.url')); ?>single/img/cooper-robo.png" class="img-fluid" alt="CooperCorp Robo" />
        </div>
...
<?php /**PATH /home/plantautomationt/public_html/resources/views/flatpages/coopercorp-industrial.blade.php ENDPATH**/ ?>