        ...
        <div class="row">
          ...
          <div class="col-md-3 col-md-3 col-sm-6 col-xs-6 e-news-btn mb-3"> 
            <div class="bg-secondary p-2">
              <a href="<?php echo e(config('app.url')); ?>e-newsletters/<?php echo e($newsletter->file); ?>" target="_blank" class="text-white font-12"><?php echo e($newsletter->title); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('../layouts/pages', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/plantautomationt/public_html/resources/views/cms/enewsarchive.blade.php ENDPATH**/ ?>