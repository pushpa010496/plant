...
<style>
  ...
  .testm-bg {
    ...
    background-image: url("<?php echo e(config('app.url')); ?>images/gl-testm-bg.jpg");
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-seconadry" role="button" id="aa" name="aa"  href="<?php echo e(url('get-listed')); ?>" aria-expanded="false">
  ...
  <div class="container-fluid text-center">
    ...
    <div class="row">
      ...
      <img src="<?php echo e(config('app.url')); ?>images/gl-banner-1.jpg" alt="Get Listed" class="img-fluid" />
      ...
      <div class="carousel-item active">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-4 col-sm-4 col-12 pl-0 pr-0 text-right">
            ...
            <img src="<?php echo e(config('app.url').'images/get-listed-banner-1.jpg'); ?>" class="img-fluid" alt="get-listed">

          </div>

          <div class="col-lg-4 col-md-4 col-sm-4 col-12 pl-0 pr-0 text-left">

            <img src="<?php echo e(config('app.url').'images/get-listed-banner-2.jpg'); ?>" class="img-fluid" alt="get-listed">

          </div>

          <div class="col-lg-4 col-md-4 col-sm-4 col-12 pl-0 pr-0 text-left">

            <img src="<?php echo e(config('app.url').'images/get-listed-banner-3.jpg'); ?>" class="img-fluid" alt="get-listed">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-8 col-md-8 col-sm-12 col-12 mb-4">
          ...
          <form method="post" action="<?php echo e(route('getlisted.post')); ?>">
           ...
           <!--  <div class="btn-group-toggle" data-toggle="buttons">
            ...
            <div class="form-prop">
                  ...
                  <div class="input-group">
                    ...
                    <div class="input-group-prepend">                      
                      ...
                      <select class="custom-select manufacturer_country_code" id="country_code" name="country_code">
                        ...
                        <option value="<?php echo e($country->country_code); ?>"><?php echo e($country->calling_code); ?></option> 
              ...
              <div class="form-row">
                ...
                <input type="hidden" name="manufacturer" value="<?php echo e(route('getlisted.post')); ?>">
          ...
          <form method="post" action="<?php echo e(route('getlisted.post')); ?>">
            ...
            <div class="form-prop">
              ...
              <div class="form-row">
                ...
                <input type="hidden" name="distributor" value="<?php echo e(route('getlisted.post')); ?>">
          ...
          <form method="post" action="<?php echo e(route('getlisted.post')); ?>">
            ...
            <div class="form-prop">
              ...
              <div class="form-row">
                ...
                <input type="hidden" name="buyer" value="<?php echo e(route('getlisted.post')); ?>">
          ...
          <div id="testimonial-slider" class="owl-carousel">
            ...
            <div class="gl-testimonial">
              ...
              <div class="pic">
                ...
                <img src="<?php echo e(config('app.url')); ?>images/testimonial-icon.jpg" alt="Company" class="img-fluid rounded-circle">
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-2 col-mg-2 col-sm-3 col-6 text-center pb-4">
        ...
        <img src="<?php echo e(config('app.url')); ?>suppliers/mitsubishi-electric-corporation/1517555519-mitsubishi.jpg" alt="" class="img-fluid border p-1" />

      </div>

      <div class="col-lg-2 col-mg-2 col-sm-3 col-6 text-center pb-4">

        <img src="<?php echo e(config('app.url')); ?>suppliers/yokogawa-europe/1517657613-yokogawa.jpg" alt="" class="img-fluid border p-1" />

      </div>      

      <div class="col-lg-2 col-mg-2 col-sm-3 col-6 text-center pb-4">

        <img src="<?php echo e(config('app.url')); ?>suppliers/gem-gebr-mller-apparatebau-gmbh-co-kg/1517635954-gemu.jpg" alt="" class="img-fluid border p-1" />

      </div>

      <div class="col-lg-2 col-mg-2 col-sm-3 col-6 text-center pb-4">

        <img src="<?php echo e(config('app.url')); ?>suppliers/die-erste-industry-co-ltd/1517464051-logo.png" alt="" class="img-fluid border p-1" />

      </div>     

      <div class="col-lg-2 col-mg-2 col-sm-3 col-6 text-center pb-4">

        <img src="<?php echo e(config('app.url')); ?>suppliers/festo-ag-co-kg/1517462331-festo-logo.jpg" alt="" class="img-fluid border p-1" />

      </div> 

      <div class="col-lg-2 col-mg-2 col-sm-3 col-6 text-center pb-4">

        <img src="<?php echo e(config('app.url')); ?>suppliers/phytron-gmbh/1517635485-phytron.jpg" alt="" class="img-fluid border p-1" />

      </div> 

      <div class="col-lg-2 col-mg-2 col-sm-3 col-6 text-center pb-4">

        <img src="<?php echo e(config('app.url')); ?>suppliers/litre-meter-limited/1517378175-litermeter.jpg" alt="" class="img-fluid border p-1" />

      </div> 

      <div class="col-lg-2 col-mg-2 col-sm-3 col-6 text-center pb-4">

        <img src="<?php echo e(config('app.url')); ?>suppliers/breton-spa/1517389419-breton.jpg" alt="" class="img-fluid border p-1" />

      </div>   

      <div class="col-lg-2 col-mg-2 col-sm-3 col-6 text-center pb-4">

        <img src="<?php echo e(config('app.url')); ?>suppliers/crane-aerospace-electronics/201902160712291194184180.jpg" alt="" class="img-fluid border p-1" />

      </div>

      <div class="col-lg-2 col-mg-2 col-sm-3 col-6 text-center pb-4">

        <img src="<?php echo e(config('app.url')); ?>suppliers/novasina-ag/1516856194-novasina.jpg" alt="" class="img-fluid border p-1" />

      </div>

      <div class="col-lg-2 col-mg-2 col-sm-3 col-6 text-center pb-4">

        <img src="<?php echo e(config('app.url')); ?>suppliers/buehler-technologies-gmbh/1541503790-Buhler.jpg" alt="" class="img-fluid border p-1" />
      ...
      <div class="col-lg-2 col-mg-2 col-sm-3 col-6 text-center pb-4">
        ...
        <p class="mb-0 border p-4 text-blue font-16">
          ...
          <a href="<?php echo e(url('clientele')); ?>" target="_blank"><i class="fa fa-plus mr-1" aria-hidden="true"></i> More</a>
...
<script>
  ...
  var countryc="<?php echo e($countrycode); ?>"
...
$("#calling_code2").val(selectedText);
  ...
  <?php if(Request::segment(1) =="get-listed-manufacturer-success"): ?>
  ...
  <?php if(Request::segment(1) =="get-listed-distributor-success"): ?>
  ...
  <?php if(Request::segment(1) =="get-listed-buyer-success"): ?>
...
$('.manufacturercontry').on('change', function() {
          ...
          $.ajax({
              ...
              url: "<?php echo e(route('dail-code')); ?>",

              type: 'POST',

              data: {country: this.value, _token: "<?php echo e(csrf_token()); ?>"},
...
<?php echo $__env->make('../layouts/pages', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/plantautomationt/public_html/resources/views/forms/get-listed-new.blade.php ENDPATH**/ ?>