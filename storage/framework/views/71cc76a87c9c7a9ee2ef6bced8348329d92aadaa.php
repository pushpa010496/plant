...
<table class="table table-bordered table-striped">
  ...
  Our Exclusive Email Marketing Program comes with  <span class='font-16 font-weight-bold' style='color:#3d3d3d'> Guaranteed ROI Assurance. 
          ...
          <div class="col-12 d-flex justify-content-center align-items-center">
      <img class="mb-2 mx-1" alt="" src="<?php echo e(config('app.url')); ?>images/online.png" data-holder-rendered="true" style="width:calc(3vh + 3vw);">
...
<table class="table table-bordered table-striped">
  ...
  <span class='font-16 font-weight-bold' style='color:#3d3d3d'>Guaranteed ROI Assurance.</span> 
          ...
          <div class="col-12 d-flex justify-content-center align-items-center">
      <img class="mb-2 mx-1" alt="" src="<?php echo e(config('app.url')); ?>images/newsletter-icon1.png" data-holder-rendered="true" style="width:calc(3vh + 3vw);">
...
<table class="table table-bordered table-striped">
  ...
  <span class='font-16 font-weight-bold' style='color:#3d3d3d'>Guaranteed ROI Assurance. 
          ...
          <div class="col-12 d-flex justify-content-center align-items-center">
      <img class="mb-2 mx-1" alt="" src="<?php echo e(config('app.url')); ?>images/digital-marketing.png" data-holder-rendered="true" style="width:calc(3vh + 3vw);">
...
<table class="table table-bordered table-striped">
  ...
  <span class='font-16 font-weight-bold' style='color:#3d3d3d'>Guaranteed ROI Assurance.
          ...
          <div class="col-12 d-flex justify-content-center align-items-center">
      <img class="mb-2 mx-1" alt="" src="<?php echo e(config('app.url')); ?>images/webinar-icon.png" data-holder-rendered="true" style="width:calc(3vh + 3vw);">
...
<td></td>
 ...
 Guaranteed results in Registrations, Attendees & Visitor Engagements.
          ...
          <div class="col-12 d-flex justify-content-center align-items-center">
      <img class="mb-2 mx-1" alt="" src="<?php echo e(config('app.url')); ?>images/writing.png" data-holder-rendered="true" style="width:calc(3vh + 3vw);">
...
<img alt="" src="https://industry.plantautomation-technology.com/images/content-marketing-graph.jpg" style="width:100%;">
  ...
  <span class='font-16 font-weight-bold text-center' style='color:#3d3d3d'>Guaranteed ROI Assurance
          ...
          <div class="col-12 d-flex justify-content-center align-items-center">
      <img class="mb-2 mx-1" alt="" src="<?php echo e(config('app.url')); ?>images/digital-marketing-icon.png" data-holder-rendered="true" style="width:calc(3vh + 3vw);">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form method="post" id="writemessage" action="<?php echo e(route('ourServices.post')); ?>">
              <?php echo csrf_field(); ?>
...
<h2 class="main-title"><span>Trusted By</span></h2>
  ...
  <?php if($cp->company): ?>
<div><img src="<?php echo e(config('app.url')); ?>suppliers/<?php echo e(str_slug(@$cp->company->comp_name)); ?>/<?php echo e(@$cp->company->comp_logo); ?>" class="img-fluid"></div>
<?php endif; ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
</div>
...
<!-- modal pop up -->
<a id="filedownload" download style="display: none" href="<?php echo e(url('/')); ?>/industry/mediapack/mediapack-plant.pdf">download</a>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <img src="<?php echo e(config('app.url')); ?>img/main-logo.png" alt="plant" width="150"/>
                    </div>
                    <div class="modal-footer">
                        <a class="btn btn-primary" role="button" id="aa" name="aa" href="<?php echo e(url('our-services')); ?>"
                            aria-expanded="false">
                            Close
                        </a>
                    </div>
...
<script type="text/javascript">
        $(document).ready(function(){
          ...
          var is_loading = true; 
          var num_messages = <?php echo e($companies_count); ?>;
          var slide_count = 6;
        });
      </script>
<script>
...
<?php echo $__env->make('../layouts/app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/plantautomationt/public_html/resources/views/forms/our-services.blade.php ENDPATH**/ ?>