    ...
    <div class="col-lg-12 mb-4">
      <div class="div-shadow p-3">  
        <div class="row">                
          ...
          <div class="col-lg-9">
            <h3 class="display-6"><?php echo e(date('d M Y',strtotime($tender->issue_date))); ?></h3>
          ...
          <div class="col-lg-9">
            <h3 class="display-6"><?php echo e(date('j F Y', strtotime($tender->action_deadline))); ?></h3>
          </div>
          ...
          <div class="col-lg-9">
            <h3 class="display-6"><?php echo e($tender->home_description); ?></h3>
          </div>
          ...
          <div class="col-lg-9">
            <h3 class="display-6 mb-0">
                            <!--  <?php if(Auth::guest()): ?>
                            <a href="#" target="_blank" class="text-blue" data-toggle="modal" data-target="#exampleModalCenter<?php echo e($tender->id); ?>">View Details</a>
                            <?php else: ?>
...
<?php /**PATH /home/plantautomationt/public_html/resources/views/tenders/filter.blade.php ENDPATH**/ ?>