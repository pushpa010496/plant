    ...
    <div class="carousel-item active">
      <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-4 col-12 pl-0 pr-0 text-right">
          <img src="<?php echo e(config('app.url').'images/get-listed-banner-1.jpg'); ?>" class="img-fluid" alt="">
        </div>
        <div class="col-lg-4 col-md-4 col-sm-4 col-12 pl-0 pr-0 text-center d-none d-sm-block">
          <img src="<?php echo e(config('app.url').'images/get-listed-banner-2.jpg'); ?>" class="img-fluid" alt="">
        </div>
        <div class="col-lg-4 col-md-4 col-sm-4 col-12 pl-0 pr-0 text-left d-none d-sm-block">
          <img src="<?php echo e(config('app.url').'images/get-listed-banner-3.jpg'); ?>" class="img-fluid" alt="">
        </div>
      </div>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-2 col-mg-2 col-sm-3 col-6 text-center pb-4">
      <img src="<?php echo e(config('app.url')); ?>suppliers/scaglia-indeva-spa/1517398922-indeva.jpg" alt="" class="img-fluid border p-1" />
    </div>
    <div class="col-lg-2 col-mg-2 col-sm-3 col-6 text-center pb-4">
      <img src="<?php echo e(config('app.url')); ?>suppliers/hydro-znphs-sp-z-oo/1517401846-logo.jpg" alt="" class="img-fluid border p-1" />
    </div>
    <div class="col-lg-2 col-mg-2 col-sm-3 col-6 text-center pb-4">
      <img src="<?php echo e(config('app.url')); ?>suppliers/festo-ag-co-kg/1517462331-festo-logo.jpg" alt="" class="img-fluid border p-1" />
    </div>
    <div class="col-lg-2 col-mg-2 col-sm-3 col-6 text-center pb-4">
      <img src="<?php echo e(config('app.url')); ?>suppliers/dfi-inc/1517494967-dfi-logo.jpg" alt="" class="img-fluid border p-1" />
    </div>
    <div class="col-lg-2 col-mg-2 col-sm-3 col-6 text-center pb-4">
      <img src="<?php echo e(config('app.url')); ?>suppliers/horiba-ltd/1517500480-horiba-logo.jpg" alt="" class="img-fluid border p-1" />
    </div>
    <div class="col-lg-2 col-mg-2 col-sm-3 col-6 text-center pb-4">
    ...
    <div class="col-lg-2 col-mg-2 col-sm-3 col-6 text-center pb-4">
      <img src="<?php echo e(config('app.url')); ?>suppliers/3s-smart-software-solutions/1517566224-3s-smart.jpg" alt="" class="img-fluid border p-1" />
    </div>
    <div class="col-lg-2 col-mg-2 col-sm-3 col-6 text-center pb-4">
      <img src="<?php echo e(config('app.url')); ?>suppliers/advantech-co-ltd/1517570217-advantech.jpg" alt="" class="img-fluid border p-1" />
    </div>
    <div class="col-lg-2 col-mg-2 col-sm-3 col-6 text-center pb-4">
    ...
    <div class="col-lg-2 col-mg-2 col-sm-3 col-6 text-center pb-4">
      <img src="<?php echo e(config('app.url')); ?>suppliers/syslogic-gmbh/1517648473-syslogic.jpg" alt="" class="img-fluid border p-1" />
    </div>
    <div class="col-lg-2 col-mg-2 col-sm-3 col-6 text-center pb-4">
    ...
    <div class="col-lg-2 col-mg-2 col-sm-3 col-6 text-center pb-4">
      <p class="mb-0 border p-4 text-blue font-weight-bold">
        <a href="<?php echo e(url('clientele')); ?>" target="_blank"><i class="fa fa-plus" aria-hidden="true"></i> More</a>
      </p>
    </div>
  </div>
</div> 
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form method="post" name="getlist_form">
                <input type="hidden" name="source" value="<?php echo e(\Request::getRequestUri()); ?>">
...
<script type="text/javascript">
  ...
  $('.submit-btn').on('click',function(e) {  
            ...
            $.ajax({
              type: 'POST',
              url: "<?php echo e(url('basic-membership')); ?>",
              headers: {
...
<?php echo $__env->make('../layouts/pages', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/plantautomationt/public_html/resources/views/forms/get-listed.blade.php ENDPATH**/ ?>