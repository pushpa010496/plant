          ...
          <div class="col-lg-9 mb-3">
            ...
            <div class="row">  
             ...
             <?php $__currentLoopData = $companyprofile; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php $__currentLoopData = $cp->ppress->where('active_flag',1)->where('stage',1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>             

                  <div class="col-lg-4 mb-4">

                    <a href="<?php echo e(config('app.url').'suppliers/'.str_slug($cp->company->comp_name).'/pressrealese/'.$value->pdf); ?>" target="_blank">

                      <img src="<?php echo e(config('app.url').'suppliers/'.str_slug($cp->company->comp_name).'/pressrealese/'.$value->image); ?>" alt="<?php echo e($value->title); ?>" class="img-fluid div-scal"/>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('../layouts/company', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/plantautomationt/public_html/resources/views/company/pressrelease.blade.php ENDPATH**/ ?>