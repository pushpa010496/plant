    ...
    <div class="container" style="margin-top:80px;">
        ...
        <div class="pt-2">
            ...
            <h1 class="text-center main-title"><span class="font-weight-bold"
                    ...
                    style='color: #92278f;font-size:24px;'><?php echo e($product_landingpages->title); ?></span></h1>



       <p><?php echo $product_landingpages->description; ?></p>

            <h2 class="text-center main-title"><span class="font-weight-bold"

                    style='color: #92278f;font-size:24px;'>Find our exclusive <?php echo e($product_landingpages->title); ?>
               ...
               ?>
                          ...
                          <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 mt-4 px-3">
                                ...
                                <div class="container border p-0" style="box-shadow: 0px 0px 6px rgb(0 0 0 / 20%); border-radius: 0.6rem; ">
                                    ...
                                    <a href="<?php echo e(url('products/'.$profile->url.'/'.$product->url)); ?>" target="_blank">

                                       <img class="img-fluid w-100" style="border-radius: 0.6rem 0.6rem 0 0;" src="<?php echo e(config('app.url').'suppliers/'.str_slug(@$profile->company->comp_name).'/products/'.$product->small_image); ?>" alt="<?php echo e($product->title); ?>">
                                  ...
                                  <div class="bg-light d-flex align-items-center justify-content-center pt-2" style="min-height: 62px;max-height: 62px;overflow: hidden;">
                                    ...
                                    <h2 class="small text-center">
                                      ...
                                      <a href="<?php echo e(url('products/'.$profile->url.'/'.$product->url)); ?>" class="text-secondary font-weight-bold" style="font-size: 15px;" target="_blank">
                                  ...
                                  <div class="text-center d-flex pb-3">
                                    ...
                                    <button type="button" class="btn mx-3 w-100 bg-white font-weight-bold rounded" style="border: 2px solid#92278f;color: #92278f;" data-toggle="modal" data-target="#enquiry" data-company_name="<?php echo e(@$profile->company->comp_name); ?>" data-company_id="<?php echo e($product->company_id); ?>" data-prod_name="<?php echo e($product->title); ?>" data-product_id="<?php echo e($product->id); ?>" data-subject_client="<?php echo e($product->title); ?> - Enquiry Submitted | Plantautomation Technology" data-subject_admin="Landing Page  Plantautomation Technology" data-page="product landing page">
                                   ...
                                   <div class="justify-content-end d-flex px-3 pb-3">
                                    ...
                                    <a href="<?php echo e(url('products/'.$profile->url.'/'.$product->url)); ?>" target="_blank" style='color:#92278f;'>more details</a>
...
<?php $__env->stopSection(); ?> -->
<?php echo $__env->make('../layouts/pages', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/plantautomationt/public_html/resources/views/flatpages/imppro-solenoid-valves.blade.php ENDPATH**/ ?>