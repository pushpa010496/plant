          ...
          <div class="col-lg-9 mb-3">
            ...
            <div class="row">  
                ...
                <div class="col-lg-4 mb-4 video">
                      ...
                      <source src="<?php echo e(config('app.url').'suppliers/'.str_slug($video->company->comp_name).'/video/'.$video->video); ?>" type="video/mp4">
                   ...
                   <?php echo e(substr($video->title,0,30)); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('../layouts/company', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/plantautomationt/public_html/resources/views/company/video.blade.php ENDPATH**/ ?>