...
<head>
	...
	<title>IoT Platforms mange and create by Telecom as a main driver of IoT – use case of Live Object </title>
	...
	<link rel="canonical" href="<?php echo e(url('mtdg-webinar')); ?>"/>
...
<div class="container-fluid fixed-top bg-light div-shadow" style="box-shadow:0px 0px 6px rgb(0 0 0 / 20%)">
	...
	<div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-4 my-auto">
						 <img src="https://industry.plantautomation-technology.com/img/main-logo.png" alt="Plantautomation Technology" class="img-fluid">
					 </div>
					 <div class="col-lg-8 col-md-8 col-sm-8 my-auto">
						 <div class='row'>
					  <div class="col-6 my-auto d-flex justify-content-center">
						 <img src="https://industry.plantautomation-technology.com/webinars/iiot/webinar-lp-header-banner-img.jpg" alt="Plantautomation Technology" class="img-fluid" data-toggle="modal" data-target="#enquiry" style='cursor:pointer;'>
					 </div>  
					 <div class="col-6  my-auto pb-2 text-right gray-text align-self-center">
						 <p class="mb-0">
							 <em class="mt-5"><span>Webinar Sponsored by</span></em>
							 <img src="https://industry.plantautomation-technology.com/webinars/iiot/industrial-iot-ai-virtual-series-logo-5.png" alt="5G-Driving" class="ml-2 img-fluid">
						 </p>
					 </div>
	</div>
	</div>
	...
	<!-- <div class="container">
		<div class="row">
			...
			<div class="col-lg-5 col-md-5 col-sm-8 my-auto offset-lg-4 pt-2 pb-2 text-right gray-text align-self-center">
				<p class="mb-0">
					<em class="mt-5"><span>Webinar Sponsored by</span></em>
					<img src="<?php echo e(config('app.url')); ?>webinars/iiot/industrial-iot-ai-virtual-series-logo-5.png"
	...
	<div class="container" style='margin-top:140px;'>
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mt-2 text-center">
				<img src="<?php echo e(config('app.url')); ?>webinars/iiot/industrial-iot-ai-virtual-series-banner-8.jpg" alt="PSI-Webinar" title="PSI-Webinar" class="img-fluid shadow" />
			</div>

			<div class="col-lg-7 col-md-7 col-sm-12 col-12">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-12 pt-3">
						<h2 class="font-weight-bold PF-TXTRED font-20">IoT Platforms mange and create by Telecom as a main driver of IoT – use case of Live Object </h2>

						
						<p class="font-weight-bold">In this webinar Sebastian Grabowski speaks about IoT Platforms mange and create by Telecom as a main driver of IoT – use case of Live Object.</p>
			...
			<div class="col-lg-5 col-md-5 col-sm-12 col-12 mt-3">
				<img type="button" data-toggle="modal" data-target="#videoFormModal" src="<?php echo e(config('app.url')); ?>webinars/iiot/orange-video.png" alt="PSI Webinar" title="PSI Webinar" class="img-fluid video shadow border text-center" />
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="p-2 PF-BrdrDDD mb-3 bg-white shadow">
					<div class="row">
						...
						<img src="<?php echo e(config('app.url')); ?>webinars/iiot/industrial-iot-ai-virtual-series-speaker-5.jpg" alt="Katarzyna Moscicka" title="Katarzyna Moscicka" class="img-fluid">
						</div>
						<div class="col-lg-10 col-md-10 col-sm-12 col-12">
							<h2 class="TXT-RED mt-2 mb-1"><strong>Sebastian Grabowski</strong></h2>
							<p class="gray-text mb-2"><em>Sebastian Grabowski PhD, graduated from the Faculty of Electronics and Telecommunications of the Koszalin University of Technology and the Faculty of Management of the University of Warsaw and is a holder of a diploma in general psychology of the Warsaw School of Social Psychology. His areas of expertiseare Open Data, Internet of things solutions for business and cities, interactions between users of telecommunication networks and the Internet. Currently the Head of Business of IoT and Advanced Technologies in Orange Polska, telecommunication company. Creator of a nationwide initiative devoted to Open Data – “BIHAPI” www.bihapi.pl. President of the ArchitectsPL Foundation, which promotes the idea of open data in Smart Cities. Lecturer at the Faculty of Management and Social Communication of the Jagiellonian University.</p>
		...
		<div class="modal-dialog modal-md">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="<?php echo e(route('orange.post')); ?>" method="post" id='writemessage' >
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group <?php echo e($errors->first('name', 'has-error')); ?>">
									...
									<input type="hidden" name="type" id="type" value="orange" />
									<input type="hidden" name="client_message" id="client_message" value="Thank you for your interest in IoT Platforms mange and create by Telecom as a main driver of IoT – use case of Live Object " />
...
<?php /**PATH /home/plantautomationt/public_html/resources/views/webinars/orange/index.blade.php ENDPATH**/ ?>