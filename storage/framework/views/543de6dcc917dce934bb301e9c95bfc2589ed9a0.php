    ...
    <div class="row">
        <div id="slider" class="carousel slide" data-ride="carousel">
            <ol class="carousel-indicators" style="right:38% !important; top:105% !important; ">
                ...
                <?php for($i=0; $i< count($sliders);$i++): ?> <li data-target="#slider" data-slide-to="<?php echo e($i); ?>" 
            ...
            <div class="carousel-inner shadow border-top">
                ...
                <div class="carousel-item  <?php echo e($key == 0 ?'active':''); ?>">
                    <a href="<?php echo e($homesliders->url); ?>" target="_blank" title="<?php echo e($homesliders->title); ?>">
                        <img class="img-fluid" src="<?php echo e(config('app.url')); ?>slider/<?php echo e($homesliders->image); ?>"
                            alt="<?php echo e($homesliders->title); ?>" style="height: auto;" />
                    </a>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
...
<div class="container">
    <div class="row">
        ...
        <?php if($homebanner12->positions[0]->id == 75 and $homebanner12->pagesCount[0]->id == 1): ?>
        ...
        <div class="col-lg-<?php echo $column ?> text-center mt-4 mb-2">
            ...
            <?php else: ?>
            <a href="javascript:void(0)" target="_blank" title="<?php echo e($homebanner12->title); ?>"
                onclick="trackOutboundLink('<?php echo e($homebanner12->url); ?>'); return false;">
                <img class="img-fluid div-shadow"
                    src="<?php echo config('app.url'); ?>slider/<?php echo $homebanner12->image;?>"
                    alt="<?php echo e($homebanner12->img_alt); ?>" title="<?php echo e($homebanner12->img_title); ?>" />
            </a>
            <?php endif; ?>
...
<?php if($homebanner12->positions[0]->id == 1 and $pcount->id == 1): ?>
<div class="col-lg-12 text-center mt-2 mb-3">
    <a href="javascript:void(0)" onclick="trackOutboundLink('<?php echo e($homebanner12->url); ?>'); return false;" target="_blank"
        class="mb-3" title="<?php echo e($homebanner12->title); ?>"><img class="img-fluid div-shadow mb-3"
            src="<?php echo config('app.url'); ?>slider/<?php echo $homebanner12->image;?>"
            alt="<?php echo e($homebanner12->img_alt); ?>" title="<?php echo e($homebanner12->img_title); ?>" /></a>
</div>
<?php else: ?>
<?php endif; ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-12 text-center mt-2 mb-3">
            <a href="javascript:void(0)" onclick="trackOutboundLink('<?php echo e($homebanner12->url); ?>'); return false;"
                target="_blank" class="mb-3" title="<?php echo e($homebanner12->title); ?>"><img class="img-fluid div-shadow mb-3"
                    src="<?php echo config('app.url'); ?>slider/<?php echo $homebanner12->image;?>"
                    alt="<?php echo e($homebanner12->img_alt); ?>" title="<?php echo e($homebanner12->img_title); ?>" /></a>
        </div>
        <?php else: ?>
...
<div class="container">
    <div class="row">
        <div class="col-lg-9 col-md-9 col-sm-12 col-12">
                           ...
                           <div class="item pr-2">
                            <div class="post-row">
                                <div class="left-meta-post">
                                    <div class="post-date"><span class="day"><?php echo e(date('d', strtotime($new->date))); ?></span><span class="month"><?php echo e(date('M', strtotime($new->date))); ?></span>
                                    </div>
                                    <div class="post-type"><i class="fa fa-picture-o "></i></div>
                                </div>
                                <h3 class="font-weight-bold" style="font-size:14px;">
                                  <a style="color:#892f79;" href="<?php echo e(url('news/'.$new->news_url)); ?>" title="<?php echo e($new->title); ?>"><?php echo e(str_limit($new->title, 90, '...')); ?></a></h3>
                              <p class="post-content mb-0" ><?php echo str_limit( $new->description, 90, '...'); ?></p>
                                  <div class=" text-right" >
                                    
                                      <a style="color:#892f79;" class="read-more" href="<?php echo e(url('news/'.$new->news_url)); ?>">Read More...</a>
            ...
            <div class="row m-0">
                <div class="col-12 p-0">
                    <a href="<?php echo e(url('/events')); ?>" target="_blank">
                        <h4 class="classic-title text-uppercase"
                            style="font-weight:400;font-size:14px;padding:0px;color:#892f79;border-bottom:1px solid #bababa;">
                        ...
                        style="opacity: 1; display: block;">
                          <?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                           <div class="item pr-2">
                            <div class="post-row">
                                <div class="left-meta-post">
                                    <div class="post-date"><span class="day"><?php echo e(date('d', strtotime($event->start_date))); ?></span><span class="month"><?php echo e(date('M', strtotime($event->start_date))); ?></span>
                                    </div>
                                    <div class="post-type"><i class="fa"><?php echo e(date('y', strtotime($event->start_date))); ?></i></div>
                                </div>
                                <h3 class="font-weight-bold" style="font-size:14px;">
                                 <?php if($event->event_url): ?>
                                 <a href="<?php echo e(url('/events')); ?>"  style="color:#892f79;" target="_blank"   title="<?php echo e($event->name); ?>"><?php echo e($event->name); ?></a>
                                  <?php else: ?>
                                  <a href="<?php echo e(url('/events')); ?>" style="color:#892f79;" target="_blank" title="<?php echo e($event->name); ?>"><?php echo e($event->name); ?></a>
                                  <?php endif; ?>
                               ...
                               <span class=""><?php echo date('j F Y', strtotime($event->start_date)); ?> &nbsp; - &nbsp; <?php echo date('j F Y', strtotime($event->end_date)); ?></span> 
    </br>
                                    <span class=""><?php echo e($event->organiser); ?>,<?php echo e($event->country); ?></span>
            ...
            <div class="row m-0 ">
                <div class="col-12 p-0">
                    <a href="<?php echo e(url('/pressreleases')); ?>" target="_blank">
                        <h4 class="classic-title text-uppercase"
                            style="font-weight:400;font-size:14px;padding:0px;color:#892f79;border-bottom:1px solid #bababa;">
                ...
                <div class="col-12 p-0">
                    <div class="latest-posts-classic owl-pressrelease owl-carousel owl-theme" data-appeared-items="2"
                        style="opacity: 1; display: block;">
                          <?php $__currentLoopData = $pressreleases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $press): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="item pr-2">
                              <div class="post-row">
                                  <div class="left-meta-post">
                                      <div class="post-date">
                                        <span class="day"><?php echo e(date('d', strtotime($press->story_date))); ?></span>
                                      <span class="month"><?php echo e(date('M', strtotime($press->story_date))); ?></span>
                                      </div>
                                      <div class="post-type"><i class="fa fa-picture-o "></i></div>
                                  </div>
                                  <h3 class="font-weight-bold" style="font-size:14px;">
                                    <a style="color:#892f79;"
                                          href="<?php echo e(url('pressreleases/'.$press->news_url)); ?>"
                                          title="<?php echo e($press->news_head); ?>"><?php echo e(str_limit( $press->news_head, 88, '...')); ?></a></h3>
                                          <p><?php echo e(str_limit( $press->home_description, 90, '...')); ?></p>
                                  <div class="post-content text-right">
                                     <a style="color:#892f79;" class="read-more"
                                              href="<?php echo e(url('pressreleases/'.$press->news_url)); ?>">Read
                                              More...</a>
                                  </div>
                              </div>
                          </div>
            ...
            <div class="row m-0">
                <div class="col-12 p-0">
                    <a href="<?php echo e('/products'); ?>" target="_blank">
                        <h4 class="classic-title text-uppercase"
                            style="font-weight:400;font-size:14px;padding:0px;color:#892f79;border-bottom:1px solid #bababa;">
                ...
                <div class="col-12 pt-3 pb-3 bg-gray nav-cust border border-secondary">
                    <div class="latest-posts-classic owl-products owl-carousel owl-theme" data-appeared-items="2"
                        style="opacity: 1; display: block;">
                          ...
                          <?php $__currentLoopData = $cp->companyproduct->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <div class="item bg-white shadow">
                              <div class="product">
                                  <div id="prodimage<?php echo e($cp->id); ?>">
                                      <a href="<?php echo e(url('products/'.@$cp->profile->url.'/'.@$product->url)); ?>">
                                          <img class="img-fluid"
                                              src="<?php echo e(config('app.url').'suppliers/'.str_slug($cp->comp_name).'/products/'.$product->small_image); ?>"
                                  ...
                                  <div class="d-flex align-items-center justify-content-center pt-2"
                                      ...
                                      <h2 class="small text-center">
                                          <a href="<?php echo e(url('products/'.@$cp->profile->url.'/'.@$product->url)); ?>"
                                              class="text-secondary font-weight-bold"><?php echo e(@$product->title); ?></a>
                                      </h2>
                                  </div>

                                  <div class="pb-5 pt-2"align="center" >
                                  <a href="<?php echo e(url('products/'.@$cp->profile->url.'/'.@$product->url)); ?>"
                                  style="color:#892f79 !important; font-weight:bold;" ><?php echo e(str_limit(@$cp->comp_name ,'25','..')); ?></a>
    
                                  </div>
                                  <!--<div class="pb-2 pt-2">-->
                                  <!--      <img class="img-fluid"-->
                                  <!--          src="<?php echo e(config('app.url').'suppliers/'.str_slug($cp->comp_name).'/'.$cp->comp_logo); ?>"-->
                                  <!--          alt="<?php echo e($cp->companyproduct[0]->alt_tag); ?>" width="100" />-->
                                  <!--  </div>-->
                              </div>
                          </div>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          ...
                          <!-- <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>-->
                          <!--  <?php $__currentLoopData = $cp->companyproduct->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>-->
                          <!--  <div class="item bg-white shadow">-->
                          <!--    <div class="product">-->
                          <!--        <div id="prodimage<?php echo e($cp->id); ?>">-->
                          <!--            <a href="<?php echo e(url('products/'.@$cp->profile->url.'/'.@$product->url)); ?>">-->
                          ...
                          <!--        </div>-->
                                  ...
                                  <!--<div class="pb-5 pt-2"align="center" >-->
                                  <!--<a href="<?php echo e(url('products/'.@$cp->profile->url.'/'.@$product->url)); ?>"-->
                                  <!--style="color:#892f79 !important; font-weight:bold;" ><?php echo e(str_limit(@$cp->comp_name ,'10','..')); ?></a>-->
                                  <!--</div>-->
            ...
            <div class="container">
                <div class="row">
                    ...
                    <?php $__currentLoopData = $banner1314; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$homebanner12): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $__currentLoopData = $homebanner12->pagesCount; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j=>$pcount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($homebanner12->positions[0]->id == 3 and $pcount->id == 1): ?>
                    <div class="col-lg-12 text-center mt-2 mb-3">
                        <a href="javascript:void(0)"
                            onclick="trackOutboundLink('<?php echo e($homebanner12->url); ?>'); return false;" target="_blank"
                            class="mb-3" title="<?php echo e($homebanner12->title); ?>"><img class="img-fluid div-shadow mb-3"
                                src="<?php echo config('app.url'); ?>slider/<?php echo $homebanner12->image;?>"
                                alt="<?php echo e($homebanner12->img_alt); ?>" title="<?php echo e($homebanner12->img_title); ?>" /></a>
                    </div>
            ...
            <div class="row m-0">
                <div class="col-12 p-0">
                    <a href="<?php echo e(url('/productlaunch')); ?>" target="_blank">
                        <h4 class="classic-title text-uppercase"
                            style="font-weight:400;font-size:14px;padding:0px;color:#892f79;border-bottom:1px solid #bababa;">
                ...
                <div class="col-12 p-0">
                    <div class="latest-posts-classic owl-product-launch owl-carousel owl-theme" data-appeared-items="2"
                        style="opacity: 1; display: block;">
                       <?php $__currentLoopData = $productluanches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productluanch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="item pr-2">
                            ...
                            <h3 class="display-6"><a style="color:#892f79;" href="<?php echo e(url('productlaunch/'.$productluanch->project_url)); ?>"><?php echo e($productluanch->title); ?></a>
                            </h3>
                            <p class="mb-0  font-13 text-justify"><?php echo $productluanch->home_description; ?></p>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
            ...
            <div class="row">
              <div class="col-12 col-md-12">
                <!-- Articles Start -->
                    <div class="row m-0">
                      <div class="col-12 p-0">
                          <a href="<?php echo e(url('articles')); ?>" target="_blank">
                              <h4 class="classic-title text-uppercase"
                                  style="font-weight:400;font-size:14px;padding:0px;color:#892f79;border-bottom:1px solid #bababa;">
                      ...
                      <div class="col-12 p-0">
                          <div class="latest-posts-classic owl-articles owl-carousel owl-theme" data-appeared-items="2"
                              style="opacity: 1; display: block;">
                              <?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $homearticles): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <div class="item">
                                  ...
                                  <h3 class="display-6"><a style="color:#892f79;" href="<?php echo e(url('articles/'.$homearticles->article_url)); ?>"><?php echo $homearticles->article_title; ?></a>
                                  </h3>
                                  <p class="mb-0  font-13 text-justify"><?php echo e(@$homearticles->short_description); ?></p>
                                  <div class="text-right">
                                      <small><a style="color:#892f79;" href="<?php echo e(url('articles/'.$homearticles->article_url)); ?>">Read More...</a></small>
                                  </div>
                              </div>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          </div>
                    ...
                    <div class="row m-0">
                      ...
                      <div class="col-12 p-0">
                          <div class="latest-posts-classic owl-experttalk owl-carousel owl-theme" data-appeared-items="2"
                              style="opacity: 1; display: block;">
                                <?php $i=1; ?>
                                  <?php $__currentLoopData = $interviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $homeinterviews): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <?php if($i==1): ?>
                                  <div class="item active ">
                                    <div class="">
                                          ...
                                          <div>
                                            ...
                                            <a href="<?php echo e(url('/interviews').'/'.$homeinterviews->interviews_url); ?>" style="color:#892f79 !important;" > <?php echo e($homeinterviews->name); ?></a></h3>
                                            <p class="mb-2"><?php echo e($homeinterviews->designation); ?></p>
                                            <p class="discription mb-2 text-justify"><?php echo e($homeinterviews->company); ?></p>
                                          </div>
                                    </div><p class="discription mb-2 text-justify"><?php echo e($homeinterviews->title); ?></p>
                                  </div>
                                  <?php else: ?>
                                  <div class="item">
                                    <div class="">
                                        ...
                                        class="img-fluid mr-3 rounded-circle mb-1 div-shadow float-left" style="max-width:180px;" alt="" width="180" />
                                          <div>
                                            ...
                                            <a  href="<?php echo e(url('/interviews').'/'.$homeinterviews->interviews_url); ?>" style="color:#892f79 !important;" > <?php echo e($homeinterviews->name); ?></a></p>
                                            <p class="mb-2 "><?php echo e($homeinterviews->designation); ?></p>
                                            <p class="discription mb-2 text-justify"><?php echo e($homeinterviews->company); ?></p>
                                          </div>
                                      </div>
                                      <p class="discription mb-2 text-justify"><?php echo e($homeinterviews->title); ?> </p>
                                  </div>
                                  <?php endif; ?>
                                  <?php $i++; ?>
                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="row">
              <div class="col-12 col-md-12 mt-3">
                <!-- Tenders Start -->
                    <div class="row m-0">
                      <div class="col-12 p-0">
                          <a href="<?php echo e(url('tenders')); ?>" target="_blank">
                              <h4 class="classic-title text-uppercase"
                                  style="font-weight:400;font-size:14px;padding:0px;color:#892f79;border-bottom:1px solid #bababa;">
                      ...
                      <div class="col-12 p-0">
                          <div class="latest-posts-classic owl-tenders owl-carousel owl-theme" data-appeared-items="2"
                              ...
                              <?php $__currentLoopData = $tenders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tender): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="item">  
                                <p class="mb-2"><strong>Title:</strong> <?php echo e(@$tender->title); ?></p>
                                <p class="mb-2"><strong>Country:</strong> <?php echo e(@$tender->region); ?>   </p>
                                <!-- <img style="margin:7px 0 0 7px;" src="<?php echo e(config('app.url')); ?>img/flags/<?php echo e(str_replace(' ', '_', @$tender->country->country_name)); ?>.png" align="right" alt="<?php echo e(@$tender->country->country_name); ?>">  -->
                                <p class="mb-2"><strong>Tender Reference:</strong> <?php echo e(@$tender->tender_reference); ?></p>
                                <p class="mb-2"><strong>Published Date:</strong> <?php echo e(date('d M Y',strtotime(@$tender->issue_date))); ?></p>
                                <p class="mb-2"><strong>Action Deadline:</strong> <?php echo e(date('j F Y', strtotime(@$tender->action_deadline))); ?></p>
                                <p class="mb-2 text-start"><strong>Short Description:</strong> <?php echo e(@$tender->home_description); ?> </p>
                                <p class="mb-2 text-right small"><a style="color:#892f79;" href="<?php echo e(url('/tenders')); ?>">Read More...</a></p> 
                              </div>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          </div>
                      </div>
              ...
              <div class="col-12 col-md-12 mt-3">
                    ...
                    <div class="row m-0">
                      <div class="col-12 p-0">
                          <a href="<?php echo e(url('projects')); ?>" target="_blank">
                              <h4 class="classic-title text-uppercase"
                                  style="font-weight:400;font-size:14px;padding:0px;color:#892f79;border-bottom:1px solid #bababa;">
                      ...
                      <div class="col-12 p-0">
                          <div class="latest-posts-classic owl-projects owl-carousel owl-theme" data-appeared-items="2"
                              style="opacity: 1; display: block;">
                                 <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $homeprojects): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <div class="item">
                                    <div class="">
                                      ...
                                      <div class="media-body">
                                        <h3 class="mt-0"><a style="color:#892f79;" href="<?php echo e(url('projects/'.$homeprojects->project_url)); ?>"><?php echo e($homeprojects->title); ?></a></h3>
                                       
                                      </div>
                                       <p class="mb-0"><?php echo str_limit( $homeprojects->home_description, 150, '...'); ?></p>
                                       <div class="text-right">
                                      <small><a style="color:#892f79;" href="<?php echo e(url('projects/'.$homeprojects->project_url)); ?>">Read More...</a></small>
                                  </div>
                                    </div>  
                                  </div>
                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="">
                ...
                <div class="owl-carousel owl_carousel_latest owl-theme">
                    <?php for($i=0; $i<$partner_count; $i++): ?> <?php $j=$i+1; ?> <div class="item">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12 text-center mt-2 mb-3">
                    <a href="javascript:void(0)" onclick="trackOutboundLink('<?php echo e($homebanner12->url); ?>'); return false;"
                        target="_blank" class="mb-3" title="<?php echo e($homebanner12->title); ?>"><img
                            ...
                            <div class="owl_testimonials owl-carousel owl-theme text-center">
                                ...
                                <div class="item active text-center">
                                    <img src="<?php echo config('app.url'); ?>testimonial/<?php echo $testimonial->image;?>"
                                        ...
                                        alt="<?php echo e($testimonial->img_alt); ?>" title="<?php echo e($testimonial->img_title); ?>"  style="max-width:180px;"/>
                                    <p class="discription"><?php echo e($testimonial->description); ?></p>
                                    <p class="name"><strong><?php echo e($testimonial->client_name); ?></strong> -
                                        <?php echo e($testimonial->company_name); ?></p>
                            ...
                            <div class="owl_testimonials3 owl-carousel owl-theme text-center">
                                ...
                                <div class="item text-center">
                                    <video controls="" width="100%" height="auto" allowfullscreen=""
                                        ...
                                        <source src="<?php echo e(config('app.url').'testimonial/plant-testimonial2.mp4'); ?>"
                                            type="video/mp4" />
                                    </video>
                                </div>
                                ...
                                <div class="item text-center">
                                    <video controls="" width="100%" height="auto" allowfullscreen=""
                                        style="max-height:300px">
                                        <source src="<?php echo e(config('app.url').'testimonial/2019-07-19 17.37.17.mp4'); ?>"
                                            type="video/mp4" />
                                    </video>
                                </div>
...
<!--
            ...
            <a href="javascript:void(0)" onclick="trackOutboundLink('<?php echo e($homebanner12->url); ?>'); return false;"
                target="_blank" class="mb-3" title="<?php echo e($homebanner12->title); ?>">
...
<div class="container">
    <div class="row">
        ...
        <?php $__currentLoopData = $banner1314; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$homebanner12): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php $__currentLoopData = $homebanner12->pagesCount; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j=>$pcount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if($homebanner12->positions[0]->id == 15 and $pcount->id == 1): ?>
        <div class="col-lg-12 text-center mt-2 mb-3">
            <a href="javascript:void(0)" onclick="trackOutboundLink('<?php echo e($homebanner12->url); ?>'); return false;"
                target="_blank" class="mb-3" title="<?php echo e($homebanner12->title); ?>">
                <img class="img-fluid div-shadow mb-3"
...
<div class="container">
    <div class="partners">
        <div class="text-center">
            <h2 class="main-title"><span><a href="<?php echo e(url('partners')); ?>">Media / Event Partners</a></span></h2>
        </div>
        ...
        <div class="col-12 mb-3">
            <div class="slick">
                ...
                <?php $__currentLoopData = $partners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $profile_logo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
$(document).ready(function() {
    ...
    var is_loading = true;
    var num_messages = <?php echo e($partners_count); ?>;

var slide_count = 6;

    var url = "<?php echo e(url('eventajaxmore')); ?>";
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('../layouts/app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/plantautomationt/public_html/resources/views/home/index.blade.php ENDPATH**/ ?>