...
<head>
	...
	<!-- Meta Tags -->
	<meta property="og:title" content="Should I stay or should I go-The Transition of Manufacturing Areas Into the 21st Century" />
	...
	<link rel="canonical" href="<?php echo e(url('joachim-webinar')); ?>"/>
			...
			<div class="row">
				<div class="col-md-8 offset-md-2 mt-4">
					<video width="100%" controls autoplay>
						<source src="https://industry.plantautomation-technology.com/webinars/joachim.mp4" type="video/mp4">
					</video>
				</div>
			</div> 
		</div>
...
<?php /**PATH /home/plantautomationt/public_html/resources/views/webinars/joachim/videosuccess.blade.php ENDPATH**/ ?>