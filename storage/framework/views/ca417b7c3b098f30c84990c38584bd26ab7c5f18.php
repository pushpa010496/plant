 ...
 <!-- // Profile Body -->
          ...
          <div class="col-lg-9 mb-3">
            ...
            <div class="row">  
             ...
             <?php $__currentLoopData = $companyprofile; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php $__currentLoopData = $cp->pproject->where('active_flag',1)->where('stage',1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pcat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>             

                  <div class="col-lg-4 mb-4">

                    <a href="<?php echo e(config('app.url').'suppliers/'.str_slug($cp->company->comp_name).'/project/'.$pcat->pdf); ?>" target="_blank">

                      <img src="<?php echo e(config('app.url').'suppliers/'.str_slug($cp->company->comp_name).'/project/'.$pcat->image); ?>" alt="<?php echo e($pcat->title); ?>" class="img-fluid div-scal"/>
      ...
      <div class="container-fluid pt-1 pb-3 text-center">
        ...
        <div class="container">
          ...
          <a href="<?php echo e(url('/get-listed')); ?>" target="_blank"><img class="img-fluid" src="<?php echo config('app.url'); ?>images/cta/company-catalogues.jpg" alt="Get Started"/> 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('../layouts/company', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/plantautomationt/public_html/resources/views/company/project.blade.php ENDPATH**/ ?>