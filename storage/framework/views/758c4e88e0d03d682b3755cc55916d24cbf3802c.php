    ...
    <div class="row">
            ...
            <div class="col-lg-12"> 
                ...
                <form>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                      ...
                      <a href="<?php echo e(url('tenders')); ?>" class="btn btn-primary btn-block">Tenders</a>
                    ...
                    <!--  <a href="<?php echo e(url('registration')); ?>" class="btn btn-block btn-primary" target="_blank">-->
              ...
              <div class="row"> 
                ...
                <div class=" p-2 border border-secondary">
                  ...
                  <a href="<?php echo e($homebanner12->url); ?>" target="_blank" class="mb-3" title="<?php echo e($homebanner12->title); ?>"><img class="img-fluid div-shadow mb-3" src="<?php echo config('app.url'); ?>slider/<?php echo $homebanner12->image;?>" alt="" /></a>
          ...
          <!-- <div class="col-lg-3 pt-2 pb-3">
            ...
            <div class="pt-2 pb-4">
              ...
              <a href="<?php echo e(url('e-newsletters')); ?>" target="_blank">
...
<script>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('../layouts/pages', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/plantautomationt/public_html/resources/views/tenders/archive.blade.php ENDPATH**/ ?>