...
<head>
	...
	<meta property="og:url" content="<?php echo e(url('mtdg-webinar')); ?>" />
			...
			<div class="row">
				<div class="col-md-8 offset-md-2 mt-4">
					<video width="100%" controls autoplay>
						<source src="https://industry.plantautomation-technology.com/webinars/orange-ondemand.mp4" type="video/mp4">
					</video>
				</div>
			</div> 
		</div>
...
<?php /**PATH /home/plantautomationt/public_html/resources/views/webinars/orange/videosuccess.blade.php ENDPATH**/ ?>