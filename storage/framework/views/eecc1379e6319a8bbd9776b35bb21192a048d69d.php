  ...
  <body>
   <header>
      <nav class="navbar navbar-expand-lg navbar-light bg-light div-shadow fixed-top">
          ...
          <img src="<?php echo e(config('app.url')); ?>images/rpa-ai/rpa-logo.png" height="60" class="img-fluid d-inline-block" alt="RPA & AI" />
          </div>                  
      </nav>  
    </header>
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title text-success"><?php echo e(session('page_type')); ?></h4>
    ...
    <script type="text/javascript">
          $(document).ready(function(){ 
              ...
              function() 
              {
               ...
               window.location.href = "<?php echo e(URL::to('download-pdf')); ?>";
              }, 1000);
          });
    </script>
    <?php endif; ?>
      ...
      <div class="row">
        ...
        <div class="col-lg-5" id="company-profile">
          <div class="border border-secondary p-3 bg-light">
            ...
            <form method="post" action="<?php echo e(route('rpa.store')); ?>">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-3 text-center pb-2">
            <img src="<?php echo e(config('app.url')); ?>images/rpa-ai/icon1.png" alt="Learn from Leaders" class="img-fluid"/>
            <p class="text-white">Learn from Leaders in the Automotive Industry</p>
          </div>

          <div class="col-lg-3 text-center pb-2">
            <img src="<?php echo e(config('app.url')); ?>images/rpa-ai/icon2.png" alt="cross-industry" class="img-fluid"/>
            <p class="text-white">Network with 60 cross-industry peers</p>
          </div>

          <div class="col-lg-3 text-center pb-2">
            <img src="<?php echo e(config('app.url')); ?>images/rpa-ai/icon3.png" alt="Empower" class="img-fluid"/>
            <p class="text-white">Empower yourself with the right solutions and services</p>
          </div>

          <div class="col-lg-3 text-center pb-2">
            <img src="<?php echo e(config('app.url')); ?>images/rpa-ai/icon4.png" alt="own interactive agenda" class="img-fluid"/>
      ...
      <div class="row">
        <div class="col-lg-2 text-center mb-4">
          <div class="img-overlay border border-secondary">
            <img src="<?php echo e(config('app.url')); ?>images/rpa-ai/speakers/elena-alfaro.jpg" alt="" class="img-fluid" />
        ...
        <div class="col-lg-2 text-center mb-4">
          <div class="img-overlay border border-secondary">
            <img src="<?php echo e(config('app.url')); ?>images/rpa-ai/speakers/keith-williams.jpg" alt="Keith Williams" class="img-fluid" />
            <div class="text-overlay">
              <div class="img-text">
        ...
        <div class="col-lg-2 text-center mb-4">
          <div class="img-overlay border border-secondary">
            <img src="<?php echo e(config('app.url')); ?>images/rpa-ai/speakers/alexander-hubel.jpg" alt="Alexander Hübel" class="img-fluid" />
            <div class="text-overlay">
              <div class="img-text">
        ...
        <div class="col-lg-2 text-center mb-4">
          <div class="img-overlay border border-secondary">
            <img src="<?php echo e(config('app.url')); ?>images/rpa-ai/speakers/dr-holger-koemm.jpg" alt="Dr Holger Koemm" class="img-fluid" />
            <div class="text-overlay">
              <div class="img-text">
        ...
        <div class="col-lg-2 text-center mb-4">
          <div class="img-overlay border border-secondary">
            <img src="<?php echo e(config('app.url')); ?>images/rpa-ai/speakers/Jose-maria-san-jose.jpg" alt="José María  San José" class="img-fluid" />
            <div class="text-overlay">
              <div class="img-text">
        ...
        <div class="col-lg-2 text-center mb-4">
          <div class="img-overlay border border-secondary">
            <img src="<?php echo e(config('app.url')); ?>images/rpa-ai/speakers/bill-bentaieb.jpg" alt="Bill Bentaieb" class="img-fluid" />
            <div class="text-overlay">
              <div class="img-text">
                <h3>Bill Bentaieb</h3>
        ...
        <div class="col-lg-2 text-center mb-4">
          <div class="img-overlay border border-secondary">
            <img src="<?php echo e(config('app.url')); ?>images/rpa-ai/speakers/andrew-pearce.png" alt="Andrew Pearce" class="img-fluid" />
            <div class="text-overlay">
              <div class="img-text">
                <h3>Andrew Pearce</h3>
        ...
        <div class="col-lg-2 text-center mb-4">
          <div class="img-overlay border border-secondary">
            <img src="<?php echo e(config('app.url')); ?>images/rpa-ai/speakers/aurelie-pols.png" alt="Aurélie Pols" class="img-fluid" />
            <div class="text-overlay">
              <div class="img-text">
                <h3>Aurélie Pols</h3>
        ...
        <div class="col-lg-2 text-center mb-4">
          <div class="img-overlay border border-secondary">
            <img src="<?php echo e(config('app.url')); ?>images/rpa-ai/speakers/sergi-mesquida.jpg" alt="Sergi Mesquida Sergi Mesquida" class="img-fluid" />
            <div class="text-overlay">
              <div class="img-text">
        ...
        <div class="col-lg-2 text-center mb-4">
          <div class="img-overlay border border-secondary">
            <img src="<?php echo e(config('app.url')); ?>images/rpa-ai/speakers/karol-kuhl.jpg" alt="Karol Kuhl" class="img-fluid" />
            <div class="text-overlay">
              <div class="img-text">
                <h3>Karol Kuhl</h3>
        ...
        <div class="col-lg-2 text-center mb-4">
          <div class="img-overlay border border-secondary">
            <img src="<?php echo e(config('app.url')); ?>images/rpa-ai/speakers/jonas-carlsson.jpg" alt="Jonas Carlsson" class="img-fluid" />
            <div class="text-overlay">
              <div class="img-text">
        ...
        <div class="col-lg-2 text-center mb-4">
          <div class="img-overlay border border-secondary">
            <img src="<?php echo e(config('app.url')); ?>images/rpa-ai/speakers/jacob-anthonsen.jpg" alt="Jacob Anthonsen" class="img-fluid" />
            <div class="text-overlay">
              <div class="img-text">
    ...
    <div class="container text-center">
      ...
      <div class="row">
        <div class="col-lg-2 text-center mb-4">
          <img src="<?php echo e(config('app.url')); ?>images/rpa-ai/corp-logos/abn-amro.jpg" alt="logo" class="img-fluid border border-secondary" />
        </div>

        <div class="col-lg-2 text-center mb-4">
          <img src="<?php echo e(config('app.url')); ?>images/rpa-ai/corp-logos/bbva.jpg" alt="logo" class="img-fluid border border-secondary" />
        </div>

        <div class="col-lg-2 text-center mb-4">
          <img src="<?php echo e(config('app.url')); ?>images/rpa-ai/corp-logos/bnp-paribas.jpg" alt="logo" class="img-fluid border border-secondary" />
        </div>

        <div class="col-lg-2 text-center mb-4">
          <img src="<?php echo e(config('app.url')); ?>images/rpa-ai/corp-logos/boots.jpg" alt="logo" class="img-fluid border border-secondary" />
        </div>

        <div class="col-lg-2 text-center mb-4">
          <img src="<?php echo e(config('app.url')); ?>images/rpa-ai/corp-logos/celonis.jpg" alt="logo" class="img-fluid border border-secondary" />
        </div>

        <div class="col-lg-2 text-center mb-4">
          <img src="<?php echo e(config('app.url')); ?>images/rpa-ai/corp-logos/close-brothers.jpg" alt="logo" class="img-fluid border border-secondary" />
        </div>

        <div class="col-lg-2 text-center mb-4">
          <img src="<?php echo e(config('app.url')); ?>images/rpa-ai/corp-logos/engie.jpg" alt="logo" class="img-fluid border border-secondary" />
        </div>

        <div class="col-lg-2 text-center mb-4">
          <img src="<?php echo e(config('app.url')); ?>images/rpa-ai/corp-logos/fidelity.jpg" alt="logo" class="img-fluid border border-secondary" />
        </div>

        <div class="col-lg-2 text-center mb-4">
          <img src="<?php echo e(config('app.url')); ?>images/rpa-ai/corp-logos/fidelity2.jpg" alt="logo" class="img-fluid border border-secondary" />
        </div>

        <div class="col-lg-2 text-center mb-4">
          <img src="<?php echo e(config('app.url')); ?>images/rpa-ai/corp-logos/heathrow.jpg" alt="logo" class="img-fluid border border-secondary" />
        </div>

        <div class="col-lg-2 text-center mb-4">
          <img src="<?php echo e(config('app.url')); ?>images/rpa-ai/corp-logos/hfs-research.jpg" alt="logo" class="img-fluid border border-secondary" />
        </div>

        <div class="col-lg-2 text-center mb-4">
          <img src="<?php echo e(config('app.url')); ?>images/rpa-ai/corp-logos/idc.jpg" alt="logo" class="img-fluid border border-secondary" />
        </div>



        <div class="col-lg-2 text-center mb-4">
          <img src="<?php echo e(config('app.url')); ?>images/rpa-ai/corp-logos/kellogg.jpg" alt="logo" class="img-fluid border border-secondary" />
        </div>

        <div class="col-lg-2 text-center mb-4">
          <img src="<?php echo e(config('app.url')); ?>images/rpa-ai/corp-logos/marherstudy.jpg" alt="logo" class="img-fluid border border-secondary" />
        </div>

        <div class="col-lg-2 text-center mb-4">
          <img src="<?php echo e(config('app.url')); ?>images/rpa-ai/corp-logos/maximise-it.jpg" alt="logo" class="img-fluid border border-secondary" />
        </div>

        <div class="col-lg-2 text-center mb-4">
          <img src="<?php echo e(config('app.url')); ?>images/rpa-ai/corp-logos/nn.jpg" alt="logo" class="img-fluid border border-secondary" />
        </div>

        <div class="col-lg-2 text-center mb-4">
          <img src="<?php echo e(config('app.url')); ?>images/rpa-ai/corp-logos/smith-nephew.jpg" alt="logo" class="img-fluid border border-secondary" />
        </div>

        <div class="col-lg-2 text-center mb-4">
          <img src="<?php echo e(config('app.url')); ?>images/rpa-ai/corp-logos/dt.jpg" alt="logo" class="img-fluid border border-secondary" />
        </div>

        <div class="col-lg-2 text-center mb-4">
          <img src="<?php echo e(config('app.url')); ?>images/rpa-ai/corp-logos/aviva.jpg" alt="logo" class="img-fluid border border-secondary" />
        </div>

        <div class="col-lg-2 text-center mb-4">
          <img src="<?php echo e(config('app.url')); ?>images/rpa-ai/corp-logos/axa.jpg" alt="logo" class="img-fluid border border-secondary" />
        </div>

        <div class="col-lg-2 text-center mb-4">
          <img src="<?php echo e(config('app.url')); ?>images/rpa-ai/corp-logos/ericsson.jpg" alt="logo" class="img-fluid border border-secondary" />
        </div>

        <div class="col-lg-2 text-center mb-4">
          <img src="<?php echo e(config('app.url')); ?>images/rpa-ai/corp-logos/metlife.jpg" alt="logo" class="img-fluid border border-secondary" />
        </div>

        <div class="col-lg-2 text-center mb-4">
          <img src="<?php echo e(config('app.url')); ?>images/rpa-ai/corp-logos/ubs.jpg" alt="logo" class="img-fluid border border-secondary" />
        </div>

        <div class="col-lg-2 text-center mb-4">
          <img src="<?php echo e(config('app.url')); ?>images/rpa-ai/corp-logos/unilever.jpg" alt="logo" class="img-fluid border border-secondary" />
        </div>
      </div>  
    </div>     
...
<?php /**PATH /home/plantautomationt/public_html/resources/views/flatpages/rpa-ai.blade.php ENDPATH**/ ?>