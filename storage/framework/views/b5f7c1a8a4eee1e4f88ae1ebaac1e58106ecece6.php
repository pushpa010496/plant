...
<div id="publishedNews" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <p><a href="<?php echo url('/');?>" title=" <?php echo e(config('app.name', 'Laravel')); ?>" target="_blank" style="color:#333333;"><img src="<?php echo e(config('app.url')); ?>img/main-logo.png" alt="Plantautomation Technology" width="250"/>   </a></p> 
     ...
     <div role="main" class="bg-white">    
      ...
      <div class="container-fluid">
        <div class="container">
         ...
         <?php $__currentLoopData = $launches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="container">
         <div class="col-lg-12">
              <h1 class="display-5 pb-3 text-blue"><?php echo e($product->title); ?></h1>
...
<script>
    ...
    $.ajax({
      type: 'post',
      url: "<?php echo e(url('repostabuse')); ?>",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('../layouts/pages', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/plantautomationt/public_html/resources/views/industry/productlauanchview.blade.php ENDPATH**/ ?>