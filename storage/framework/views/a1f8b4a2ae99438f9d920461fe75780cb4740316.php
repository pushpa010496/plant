...
<head>
	...
	<meta property="og:image" content="https://industry.plantautomation-technology.com/webinars/iiot/infogain-video.png" />
		...
		<div class="row">
			...
			<div class="col-6  my-auto pb-2 text-right gray-text align-self-center">
				<p class="mb-0">
					...
					<img src="<?php echo e(config('app.url')); ?>webinars/iiot/industrial-iot-ai-virtual-series-logo-1.png"
	...
	<div class="container" style='margin-top:140px;'>
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mt-2 text-center">
				<img src="<?php echo e(config('app.url')); ?>webinars/iiot/industrial-iot-ai-virtual-series-banner-4.jpg" alt="PSI-Webinar" title="PSI-Webinar" class="img-fluid shadow" />
			</div>
			...
			<div class="col-lg-5 col-md-5 col-sm-12 col-12 mt-3">
				<img type="button" data-toggle="modal" data-target="#videoFormModal" src="<?php echo e(config('app.url')); ?>webinars/iiot/infogan.png" alt="PSI Webinar" title="PSI Webinar" class="img-fluid video shadow border text-center" />
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="p-2 PF-BrdrDDD mb-3 bg-white shadow">
					<div class="row">
						...
						<img src="<?php echo e(config('app.url')); ?>webinars/iiot/industrial-iot-ai-virtual-series-speaker-1.jpg" alt="Katarzyna Moscicka" title="Katarzyna Moscicka" class="img-fluid">
						</div>
		...
		<div class="modal-dialog modal-md">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="<?php echo e(route('infogain.post')); ?>" method="post" id='writemessage' >
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group <?php echo e($errors->first('name', 'has-error')); ?>">
									...
									<input type="hidden" name="type" id="type" value="infogain" />
									<input type="hidden" name="client_message" id="client_message" value="Thank you for your interest in Predictive Maintenance with IoT and Data Analytics – Challenges and Solution." />
...
<?php /**PATH /home/plantautomationt/public_html/resources/views/webinars/infogain/index.blade.php ENDPATH**/ ?>