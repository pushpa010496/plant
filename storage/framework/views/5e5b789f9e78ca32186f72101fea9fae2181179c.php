...
<head>
	...
	<link rel="canonical" href="<?php echo e(url('5g-webinar')); ?>"/>
		...
		<div class="row">
			...
			<div class="col-lg-5 col-md-5 col-sm-5 my-auto  pt-2 pb-2 text-right gray-text align-self-center">
				<p class="mb-0">
					...
					<img src="<?php echo e(config('app.url')); ?>webinars/iiot/industrial-iot-ai-virtual-series-logo-2.png"
	...
	<div class="container" style='margin-top:120px;'>
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mt-2 text-center">
				<img src="<?php echo e(config('app.url')); ?>webinars/iiot/industrial-iot-ai-virtual-series-banner-5.jpg" alt="PSI-Webinar" title="PSI-Webinar" class="img-fluid shadow" />
			</div>
			...
			<div class="col-lg-5 col-md-5 col-sm-12 col-12 mt-3">
				<img type="button" data-toggle="modal" data-target="#videoFormModal" src="<?php echo e(config('app.url')); ?>webinars/iiot/5g-webinar-video-thumb.png" alt="PSI Webinar" title="PSI Webinar" class="img-fluid video shadow border text-center" />
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="p-2 PF-BrdrDDD mb-3 bg-white shadow">
					<div class="row">
						...
						<img src="<?php echo e(config('app.url')); ?>webinars/iiot/industrial-iot-ai-virtual-series-speaker-2.jpg" alt="Katarzyna Moscicka" title="Katarzyna Moscicka" class="img-fluid">
						</div>
		...
		<div class="modal-dialog modal-md">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="<?php echo e(route('5gwebinar.post')); ?>" method="post" id='writemessage' >
...
<?php /**PATH /home/plantautomationt/public_html/resources/views/webinars/suezozonia/index.blade.php ENDPATH**/ ?>