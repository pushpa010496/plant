...
<div class="container pt-4 pb-3">
  ...
  <div class="row">
    ...
    <!-- <div class="col-lg-8 offset-lg-2 mt-4" id="main-search">
      ...
      <form method="get" action="<?php echo e(route('new-search')); ?>" >
  ...
  <div class="container mb-4">
    ...
    <h1 style="font-size:24px;">Search result of "<?php echo e(str_replace("-"," ",ucwords($url))); ?>"</h1>
...
<?php echo $__env->make('../layouts/pages', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/plantautomationt/public_html/resources/views/company/product-keyword-search.blade.php ENDPATH**/ ?>