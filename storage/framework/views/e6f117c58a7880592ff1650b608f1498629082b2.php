            ...
            <tr>
              <td>
                <table width="500" border="0" cellpadding="5">
                  ...
                  <tr>
                    <td width="20">&nbsp;</td>
                    <td width="200" align="left" valign="middle" style="font-family:Arial, Helvetica, sans-serif;font-size:14px;font-weight:bold;">Visitor Company</td>
                    <td width="30" align="left" valign="middle"><strong>:</strong></td>
                  ...
                  <tr>
                    <tr>
                      <td width="20">&nbsp;</td>
                      <td width="200" align="left" valign="middle" style="font-family:Arial, Helvetica, sans-serif;font-size:14px;font-weight:bold;">Enquiry for</td>
                      <td width="30" align="left" valign="middle"><strong>:</strong></td>
                      <td width="330" align="left" valign="middle" style="font-family:Arial, Helvetica, sans-serif;font-size:15px;"><?php echo e($comp_name); ?></td>
                    </tr>
                  ...
                  <tr>
                    <td width="20">&nbsp;</td>
                    <td width="200" align="left" valign="middle" style="font-family:Arial, Helvetica, sans-serif;font-size:14px;font-weight:bold;">Question</td>
                    <td width="30" align="left" valign="middle"><strong>:</strong></td>
...
<?php /**PATH /home/plantautomationt/public_html/resources/views/emails/question/admin.blade.php ENDPATH**/ ?>