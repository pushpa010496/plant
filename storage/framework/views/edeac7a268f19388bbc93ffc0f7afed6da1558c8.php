              ...
              <div class="form-container"> 
                ...
                <div class="input-container"> 
                  ...
                  <div class="row input-group req-input"> 
                    ...
                    <?php echo e(Form::text('cf_leads_eventname', null,['placeholder'=>"Enter Event Name...",'pattern'=>"[A-Za-z\s]{3,30}" ,'title'=>"Enter only alphabets ",'required'=>'required'])); ?>


                  </div> 

                  <?php if($errors->has('cf_leads_eventname')): ?>

                  <span class="text-danger"><?php echo e($errors->first('cf_leads_eventname')); ?></span>
                  ...
                  <div class="row input-group req-input"> 
                    ...
                    <?php echo e(Form::text('cf_leads_eventvenue', null,['placeholder'=>"Event Venue "])); ?>


                  </div> 

                  <?php if($errors->has('cf_leads_eventvenue')): ?>

                  <span class="text-danger"><?php echo e($errors->first('cf_leads_eventvenue')); ?></span>
                  ...
                  <div class="row input-group req-input"> 
                    ...
                    <?php echo e(Form::text('cf_leads_eventaddress', null,['placeholder'=>"Enter Your Event Address..."])); ?>


                  </div> 

                  <?php if($errors->has('cf_leads_eventaddress')): ?>

                  <span class="text-danger"><?php echo e($errors->first('cf_leads_eventaddress')); ?></span>
                  ...
                  <div class="row input-group req-input"> 
                    ...
                    <?php echo e(Form::text('cf_leads_startdate', null,['placeholder'=>"Start Date...",'id'=>'from'])); ?>


                  </div> 

                  <?php if($errors->has('cf_leads_startdate')): ?>

                  <span class="text-danger"><?php echo e($errors->first('cf_leads_startdate')); ?></span>
                  ...
                  <div class="row input-group req-input"> 
                    ...
                    <?php echo e(Form::text('cf_leads_enddate', null,['placeholder'=>"End Date...",'id'=>'to'])); ?>


                  </div> 

                  <?php if($errors->has('cf_leads_enddate')): ?>

                  <span class="text-danger"><?php echo e($errors->first('cf_leads_enddate')); ?></span>

                  <?php endif; ?>

                   <div class="row input-group req-input"> 

                    <?php echo e(Form::text('cf_leads_jobtitle', null,['placeholder'=>"Enter Job Title..." ,'title'=>"Enter only alphabets ",'required'=>'required'])); ?>
                  ...
                  <span class="text-danger"><?php echo e($errors->first('cf_leads_jobtitle')); ?></span>

                  <?php endif; ?>

                   <div class="row input-group req-input"> 

                    <?php echo e(Form::text('cf_leads_organiser', null,['placeholder'=>" Event Organiser..."])); ?>


                  </div> 

                  <?php if($errors->has('cf_leads_organiser')): ?>

                  <span class="text-danger"><?php echo e($errors->first('cf_leads_organiser')); ?></span>

                  <?php endif; ?>

                   <div class="row input-group req-input"> 

                    <?php echo e(Form::text('cf_leads_weblink', null,['placeholder'=>"Event Web Link..."])); ?>
                  ...
                  <span class="text-danger"><?php echo e($errors->first('cf_leads_countryname')); ?></span>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('../layouts/pages', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/plantautomationt/public_html/resources/views/forms/postevent.blade.php ENDPATH**/ ?>