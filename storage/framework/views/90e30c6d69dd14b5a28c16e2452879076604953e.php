...
<head>
	...
	<title>SProductionizing AI in Manufacturing</title>

	<link rel="shortcut icon" href="<?php echo e(config('app.url')); ?>img/favicon.ico" type="image/x-icon">

	<!-- Meta Tags -->
	<meta property="og:title" content="Productionizing AI in Manufacturing" />
	...
	<meta property="og:image" content="https://industry.plantautomation-technology.com/webinars/iiot/productionizing-video.png" />
	<link rel="canonical" href="<?php echo e(url('sorbotics-webinar')); ?>"/>
	...
	<meta property="og:url" content="<?php echo e(url('sorbotics-webinar')); ?>" />
			...
			<div class="row">
				<div class="col-md-8 offset-md-2 mt-4">
					<video width="100%" controls autoplay>
						<source src="https://industry.plantautomation-technology.com/webinars/productionizing.mp4" type="video/mp4">
					</video>
				</div>
			</div> 
		</div>
...
<?php /**PATH /home/plantautomationt/public_html/resources/views/webinars/productionizing/videosuccess.blade.php ENDPATH**/ ?>