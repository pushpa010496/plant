 ...
 <!-- // Profile Body -->
          ...
          <div class="col-lg-9 mb-3">
            ...
            <div class="row">  
             ...
             @foreach($companyprofile as $cp)
                ...
                @foreach($cp->pproject->where('active_flag',1)->where('stage',1) as $pcat)             

                  <div class="col-lg-4 mb-4">

                    <a href="{{config('app.url').'suppliers/'.str_slug($cp->company->comp_name).'/project/'.$pcat->pdf}}" target="_blank">

                      <img src="{{config('app.url').'suppliers/'.str_slug($cp->company->comp_name).'/project/'.$pcat->image}}" alt="{{$pcat->title}}" class="img-fluid div-scal"/>
      ...
      <div class="container-fluid pt-1 pb-3 text-center">
        ...
        <div class="container">
          ...
          <a href="{{url('/get-listed')}}" target="_blank"><img class="img-fluid" src="<?php echo config('app.url'); ?>images/cta/company-catalogues.jpg" alt="Get Started"/> 
