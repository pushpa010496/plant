...
<div role="main {{ @$page_all}}">
  ...
  <div class="container pb-3">
    <div class="row">        
     ...
     @include('company.featuredfilter')          
    ...
    <a href=" javascript:void(0)" target="_blank" class="mb-3" title="{{$homebanner12->title}}" onclick="trackOutboundLink('{{$homebanner12->url}}'); return false;">
