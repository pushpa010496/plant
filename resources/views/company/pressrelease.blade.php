          ...
          <div class="col-lg-9 mb-3">
            ...
            <div class="row">  
             ...
             @foreach($companyprofile as $cp)
                ...
                @foreach($cp->ppress->where('active_flag',1)->where('stage',1) as $value)             

                  <div class="col-lg-4 mb-4">

                    <a href="{{config('app.url').'suppliers/'.str_slug($cp->company->comp_name).'/pressrealese/'.$value->pdf}}" target="_blank">

                      <img src="{{config('app.url').'suppliers/'.str_slug($cp->company->comp_name).'/pressrealese/'.$value->image}}" alt="{{$value->title}}" class="img-fluid div-scal"/>
