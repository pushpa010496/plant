...
<div class="container pt-4 pb-3">
  <form action="{{url('product-enquiry')}}"  class="product_form" method="post" >
    ...
    <div class="row" id="product">              
      ...
      @foreach($cp->pproduct->whereNotIn('url',\Request::segment(3))->where('active_flag',1)->where('stage',1) as $cproduct) 
