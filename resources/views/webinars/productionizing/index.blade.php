...
<head>
	...
	<title>Productionizing AI in Manufacturing.</title>
	...
	<meta property="og:image" content="https://industry.pharmafocusasia.com/webinars/suez-ozonia/suez-ozone-ondemand-banner.jpg" />
	<link rel="canonical" href="{{url('webinar-demo/suez-ozonia-ozone-systems-webinar')}}"/>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-6 my-auto d-flex justify-content-center">
						 <img src="{{config('app.url')}}webinars/iiot/webinar-lp-header-banner-img.jpg" alt="Plantautomation Technology" class="img-fluid" data-toggle="modal" data-target="#enquiry" style='cursor:pointer;'>
					 </div>
			<div class="col-6  my-auto pb-2 text-right gray-text align-self-center">
				<p class="mb-0">
					<em class="mt-5"><span>Webinar Sponsored by</span></em>
					<img src="{{config('app.url')}}webinars/iiot/industrial-iot-ai-virtual-series-logo-4.png"
	...
	<div class="container" style='margin-top:140px;'>
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mt-2 text-center">
				<img src="{{config('app.url')}}webinars/iiot/industrial-iot-ai-virtual-series-banner-7.jpg" alt="PSI-Webinar" title="PSI-Webinar" class="img-fluid shadow" />
			</div>

			<div class="col-lg-7 col-md-7 col-sm-12 col-12">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-12 pt-3">
						<h2 class="font-weight-bold PF-TXTRED font-20">Productionizing AI in Manufacturing.</h2>

						<p class="font-weight-bold">Your traditional process control techniques associated with costly energy consuming assets, i.e. boilers/compressors, are complex requiring an overwhelming amount of time and resources that don’t guarantee results and prove difficult to scale across the enterprise. This webinar seeks to bring awareness on how the Smart Industry community can adopt an Industry 4.0 approach in reducing real-time energy costs by taking an operational edge AI/ML framework in democratizing the implementation of industrial AI analytics solutions that can be implemented in a matter of minutes, all without having to become a data scientist or script any code.</p>
						

					<p class="TXT-BLUE font-weight-bold mb-1">Join us to explore:</p>

						<ul style="padding-left: 20px; line-height: 1.3;">
							<li>How maintenance/process engineers make are adding practical augmented AI intelligence to their PID techniques even in the midst of an existing Industry 3.0 infrastructure and control systems.</li>
							<li>How manufacturing citizen data scientists are improving common industry KPI’s such as KwH generated and Natural Gas consumed in real-time.</li>
							<li>How to configure an edge AI data driven operational baseline of your energy assets, not rules based or human subjectivity, in addition to mitigating the manipulation of your single source of truth.</li>
							<li>The techniques of deploying an edge AI operational digital twin ML model to forecast/recommend production and planning supply chain events.</li>
							<li>Why edge based AI can automatically optimize your process equipment parameters, reinforce a SMART dynamic setpoint in real-time and provide high levels of root causal analysis/fidelity and industrial problem solving!</li>
						</ul>
					</div>
				</div> 
			</div>
			...
			<div class="col-lg-5 col-md-5 col-sm-12 col-12 mt-3">
				<img type="button" data-toggle="modal" data-target="#videoFormModal" src="{{config('app.url')}}webinars/iiot/productionizing-video.png" alt="PSI Webinar" title="PSI Webinar" class="img-fluid video shadow border text-center" />
				<div class="p-2 PF-BrdrDDD mb-1 bg-light shadow mt-4" align="center">
					<h3 class="pt-1 pb-1">
						<strong class="TXT-RED font-20">March 29, 2021</strong>
						<span class="small text-secondary ml-2 mr-3">(Monday)</span>
						<p class="mt-2 mb-0 font-weight-bold font-16">03:00 PM (IST)</p>
					</h3>						
				</div>
			</div>
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="p-2 PF-BrdrDDD mb-3 bg-white shadow">
					<div class="row">
						...
						<img src="{{config('app.url')}}webinars/iiot/industrial-iot-ai-virtual-series-speaker-4.jpg" alt="Katarzyna Moscicka" title="Katarzyna Moscicka" class="img-fluid">
						</div>
						<div class="col-lg-10 col-md-10 col-sm-12 col-12">
							<h2 class="TXT-RED mt-2 mb-1"><strong>AJ Alexander</strong></h2>
							<p class="gray-text mb-2"><em>Co-Founder,Sorbotics</em></p>
							<p class="mb-1">AJ is a data-driven entrepreneurial change agent that began his career working for several R&D/biomechanical startups across the globe, designing and implementing cutting edge technology programs to hack human performance outputs for MLB clients. He was then recruited to run a $6 million P&L for a digital transformation consulting firm based out of Jacksonville, FL. Most of his efforts were spent on architecting enterprise roadmaps, for fortune 500 manufactures, to adopt AI & IIoT technologies thus transforming legacy supply chains into digitalization pioneers.</p>
						</div> 
					</div>
				</div>
			</div>
		...
		<div class="modal-dialog modal-md">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="{{ route('sorbotics.post') }}" method="post" id='writemessage' >
						{{ csrf_field() }}	
						<div class="row">
							<div class="col-md-12">
								<div class="form-group {{ $errors->first('name', 'has-error')}}">
									<input class="form-control" id="name" name="name" placeholder="Full Name *" required=""  value="{{ old('name') }}"  type="text">	
									<input type="hidden" name="type" id="type" value="sorbotics" />
									<input type="hidden" name="client_message" id="client_message" value="Thank you for your interest in productionizing webinar" />
							...
							<div class="col-md-12">
								<div class="form-group">
									<div class="custom-control custom-checkbox mb-1">
										...
										<label class="custom-control-label font-13" for="email_updates">I would like to receive email updates about Productionizing AI in Manufacturing.</label>
									</div>
									<div class="custom-control custom-checkbox mb-1">
									...
									<div class="custom-control custom-checkbox mb-1">
										...
										<label class="custom-control-label font-13" for="representative">I have more questions and would like to be contacted by Productionizing.</label>
									</div>
								</div>
							</div>
