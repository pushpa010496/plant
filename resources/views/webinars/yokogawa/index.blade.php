		...
		<div class="row">
			...
			<div class="col-6  my-auto pb-2 text-right gray-text align-self-center">
				<p class="mb-0">
					...
					<img src="{{config('app.url')}}webinars/iiot/industrial-iot-ai-virtual-series-logo-7.png"
	...
	<div class="container" style='margin-top:140px;'>
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mt-2 text-center">
				<img src="{{config('app.url')}}webinars/iiot/industrial-iot-ai-virtual-series-banner-10.jpg" alt="PSI-Webinar" title="PSI-Webinar" class="img-fluid shadow" />
			</div>
			...
			<div class="col-lg-5 col-md-5 col-sm-12 col-12 mt-3">
				<img type="button" data-toggle="modal" data-target="#videoFormModal" src="{{config('app.url')}}webinars/iiot/yokogawa-video.png" alt="PSI Webinar" title="PSI Webinar" class="img-fluid video shadow border text-center" />
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="p-2 PF-BrdrDDD mb-3 bg-white shadow">
					<div class="row">
						...
						<img src="{{config('app.url')}}webinars/iiot/industrial-iot-ai-virtual-series-speaker-7.jpg" alt="Katarzyna Moscicka" title="Katarzyna Moscicka" class="img-fluid">
						</div>
		...
		<div class="modal-dialog modal-md">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="{{ route('yokogawa.post') }}" method="post" id='writemessage' >
						{{ csrf_field() }}	
						<div class="row">
							<div class="col-md-12">
