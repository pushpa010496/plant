...
<head>
	...
	<title>Enabling The Future Of The Global Smart Logistics Network</title>

	<link rel="shortcut icon" href="{{ config('app.url') }}img/favicon.ico" type="image/x-icon">

	<!-- Meta Tags -->
	<meta property="og:title" content="Enabling The Future Of The Global Smart Logistics Network" />
	...
	<meta property="og:image" content="https://industry.plantautomation-technology.com/webinars/iiot/ups-video.png" />
	<link rel="canonical" href="{{url('ups-webinar')}}"/>
	...
	<meta property="og:url" content="{{url('ups-webinar')}}" />
		...
		<div class="row">
			...
			<div class="col-6  my-auto pb-2 text-right gray-text align-self-center">
				<p class="mb-0">
					...
					<img src="{{config('app.url')}}webinars/iiot/industrial-iot-ai-virtual-series-logo-8.png"
	...
	<div class="container" style='margin-top:140px;'>
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mt-2 text-center">
				<img src="{{config('app.url')}}webinars/iiot/industrial-iot-ai-virtual-series-banner-11.jpg" alt="PSI-Webinar" title="PSI-Webinar" class="img-fluid shadow" />
			</div>

			<div class="col-lg-7 col-md-7 col-sm-12 col-12">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-12 pt-3">
						<h2 class="font-weight-bold PF-TXTRED font-20">Enabling The Future Of The Global Smart Logistics Network.</h2>

						<p class="font-weight-bold">The UPS Advanced Technology Group (ATG) is responsible for research, testing and development of new technologies and models that will improve UPS’s Global Smart Logistics Network.</p>

						<p class="font-weight-bold">The group accelerates decisions and improves collaboration as UPS implements key components of its next-generation network.</p>

						<p class="font-weight-bold">The team finds the right technologies to kick our Smart Logistics Network into overdrive for the benefit of our customers.</p>
			...
			<div class="col-lg-5 col-md-5 col-sm-12 col-12 mt-3">
				<img type="button" data-toggle="modal" data-target="#videoFormModal" src="{{config('app.url')}}webinars/iiot/ups-video.png" alt="PSI Webinar" title="PSI Webinar" class="img-fluid video shadow border text-center" />
				<div class="p-2 PF-BrdrDDD mb-1 bg-light shadow mt-4" align="center">
					<h3 class="pt-1 pb-1">
						...
						<p class="mt-2 mb-0 font-weight-bold font-16">03:30 PM (IST)</p>
					</h3>						
				</div>
			</div>
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="p-2 PF-BrdrDDD mb-3 bg-white shadow">
					<div class="row">
						...
						<img src="{{config('app.url')}}webinars/iiot/industrial-iot-ai-virtual-series-speaker-8.jpg" alt="Katarzyna Moscicka" title="Katarzyna Moscicka" class="img-fluid">
						</div>
						<div class="col-lg-10 col-md-10 col-sm-12 col-12">
							<h2 class="TXT-RED mt-2 mb-1"><strong>Jon Gurney Bell</strong></h2>
							<p class="gray-text mb-2"><em>Strategic innovation lead</em></p>
							<p class="mb-1">Jon Gurney Bell leads strategic innovation at UPS’s Advanced Technology Group (ATG) group (Also referred to as the UPS Innovation factory). In this role he is responsible for.</p>
							<ul>
								<li>Understanding customer needs and behaviors for both today and tomorrow</li>
								<li>How innovation, decision making, and collaboration can be applied and scaled to solve problems</li>
								<li>Applying cutting-edge technologies to create and enhance UPS's Global Smart Logistics Network</li>
							</ul>
						</div> 
					</div>
				</div>
		...
		<div class="modal-dialog modal-md">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="{{ route('ups.post') }}" method="post" id='writemessage' >
						{{ csrf_field() }}	
						<div class="row">
							<div class="col-md-12">
								<div class="form-group {{ $errors->first('name', 'has-error')}}">
									<input class="form-control" id="name" name="name" placeholder="Full Name *" required=""  value="{{ old('name') }}"  type="text">	
									<input type="hidden" name="type" id="type" value="Enabling The Future Of The Global Smart Logistics Network." />
									<input type="hidden" name="client_message" id="client_message" value="Thank you for your interest in Enabling The Future Of The Global Smart Logistics Network." />
