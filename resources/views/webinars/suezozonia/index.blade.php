...
<head>
	...
	<title>5G Driving the Future of Industry 4.0 and Smart Manufacturing</title>

	<link rel="shortcut icon" href="{{ config('app.url') }}img/favicon.ico" type="image/x-icon">

	<!-- Meta Tags -->
	<meta property="og:title" content="5G Driving the Future of Industry 4.0 and Smart Manufacturing" />
	...
	<meta property="og:image" content="https://industry.plantautomation-technology.com/webinars/iiot/5g-webinar-video-thumb.png" />
	<link rel="canonical" href="{{url('5g-webinar')}}"/>
...
<div class="container-fluid fixed-top bg-light div-shadow" style="box-shadow:0px 0px 6px rgb(0 0 0 / 20%)" >
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-4 my-auto d-flex justify-content-center">
			...
			<div class="col-lg-5 col-md-5 col-sm-5 my-auto  pt-2 pb-2 text-right gray-text align-self-center">
				<p class="mb-0">
					<em class="mt-5"><span>Webinar Sponsored by</span></em>
					<img src="{{config('app.url')}}webinars/iiot/industrial-iot-ai-virtual-series-logo-2.png"
	...
	<div class="container" style='margin-top:120px;'>
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mt-2 text-center">
				<img src="{{config('app.url')}}webinars/iiot/industrial-iot-ai-virtual-series-banner-5.jpg" alt="PSI-Webinar" title="PSI-Webinar" class="img-fluid shadow" />
			</div>

			<div class="col-lg-7 col-md-7 col-sm-12 col-12">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-12 pt-3">
						<h2 class="font-weight-bold PF-TXTRED font-20">5G Driving the Future of Industry 4.0 and Smart Manufacturing.</h2>

						<p class="font-weight-bold">5G is an acknowledged technology pillar for Industry 4.0. With smart manufacturing forecast to reach $40 Billion in 2026, it is one of the fastest growing sectors of the 5G market. 5G offers manufacturers the opportunity to build smart factories and supply chains that take advantage of technologies such as automation, artificial intelligence, augmented reality, and the Internet of Things.</p>
						

					<!-- 	<p class="TXT-BLUE font-weight-bold mb-1">In this webinar, participants will learn about.</p>

						<ul style="padding-left: 20px; line-height: 1.3;">
							<li>The value of PSI and how it was the best CRO in the world as measured by our employees, clients, investigators, and vendors.</li>
						</ul> -->
					</div>
				</div> 
			</div>
			...
			<div class="col-lg-5 col-md-5 col-sm-12 col-12 mt-3">
				<img type="button" data-toggle="modal" data-target="#videoFormModal" src="{{config('app.url')}}webinars/iiot/5g-webinar-video-thumb.png" alt="PSI Webinar" title="PSI Webinar" class="img-fluid video shadow border text-center" />
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="p-2 PF-BrdrDDD mb-3 bg-white shadow">
					<div class="row">
						...
						<img src="{{config('app.url')}}webinars/iiot/industrial-iot-ai-virtual-series-speaker-2.jpg" alt="Katarzyna Moscicka" title="Katarzyna Moscicka" class="img-fluid">
						</div>
						<div class="col-lg-10 col-md-10 col-sm-12 col-12">
							<h2 class="TXT-RED mt-2 mb-1"><strong>Chris Pearson</strong></h2>
							<p class="gray-text mb-2"><em>President</em></p>
							<p class="mb-1">Chris Pearson is the President of 5G Americas. In his executive role, he is responsible for the overall planning of the organization and providing management for the integration of strategy and operations in the areas of technology, marketing, public relations and regulatory affairs.With more than 33 years of experience in the telecommunications industry, Mr. Pearson is a recognized spokesperson in mobile wireless and 5G technology trends and has spoken at technology conferences throughout the world including CES, Mobile World Congress, CTIA, 5G World North America, and The Big 5G Event.</p>
						</div> 
					</div>
				</div>
			</div>
		...
		<div class="modal-dialog modal-md">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="{{ route('5gwebinar.post') }}" method="post" id='writemessage' >
						{{ csrf_field() }}	
						<div class="row">
							<div class="col-md-12">
								<div class="form-group {{ $errors->first('name', 'has-error')}}">
									<input class="form-control" id="name" name="name" placeholder="Full Name *" required=""  value="{{ old('name') }}"  type="text">	
									<input type="hidden" name="type" id="type" value="5G Driving" />
									<input type="hidden" name="formtype"  value="modal-form" />
									<input type="hidden" name="client_message" id="client_message" value="5G Driving the Future of Industry 4.0 and Smart Manufacturing" />
