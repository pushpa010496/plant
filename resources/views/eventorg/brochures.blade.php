        ...
        <div class="row">
            <div class="col-lg-9">           
             @foreach($brochures as $cp)
                ...
                <a target="_blank" href="{{ config('app.url') }}event/organiser/brochure/{{$cp->pdf}}"><img class="img-fluid div-scal" src="{{ config('app.url') }}event/organiser/brochure/{{$cp->image}}" alt="{{$cp->img_alt}}"></a>
              </div>
              @endforeach      
            </div>
