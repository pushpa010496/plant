        ...
        <div class="row">
            <div class="col-lg-9">  
              ...
              @foreach($galleries as $cp)
                ...
                <a href="{{ config('app.url') }}event/organiser/gallery/{{$cp->big_img}}" data-toggle="lightbox" data-gallery="example-gallery">
                  <img src="{{ config('app.url') }}event/organiser/gallery/{{$cp->small_img}}" class="img-fluid div-scal">
                </a>
              </div>
              @endforeach      
            </div>
