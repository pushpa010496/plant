...
<table width="500" border="0" align="left" cellpadding="10">
  ...
  <tr>
    <td style="font-family:Arial, Helvetica, sans-serif;font-size:16px;padding-left:30px;">{{$name}} from {{$company}} wishes to contact PlantAutomation for a query.</td>
  </tr>
  ...
  <tr>
    <td>
      <table width="500" border="0" cellpadding="5">
          ...
          <tr>
            <td width="20">&nbsp;</td>
             <td width="330" align="left" valign="middle" style="font-family:Arial, Helvetica, sans-serif;font-size:15px;"><a href="{{ url('/contactus')}}">{{ url('/contactus')}}</a></td>
            </tr>
      </table>
