  ...
  <div class="container pb-3">
    <div class="row">        
      <div class="col-lg-8 pt-5"> 
        <div class="row">
          @if(@$data[0] != 'nocategory')
          <div class="col-lg-12 bg-light border border-secondary">
            <h1 class="display-5 mb-3 pt-3 " style="text-transform: capitalize"> <strong>{{strtolower ($category->name) }} Suppliers in {{$country }} </strong></h1>
            @if(count($data) != 0)
            ...
            <div class="suppliers mt-2 mb-4">
              ...
              {{-- @if($company->companyprofile[0]->active_flag == 1) --}}





              {{-- {{ @$company->companyproduct[0]->category->ParentCategory->name }} --}}



              <h3 class="display-6 mb-3"><a href="{{url('suppliers').'/'. @$product->company->companyprofile[0]->url }}">{{ $product->company->comp_name }}</a> 
