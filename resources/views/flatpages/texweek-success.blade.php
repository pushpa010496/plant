...
If you face any diffculty in downloading or viewing the interview kindly get back to us at <a href="#">info@plantautomation.com</a></p>
    ...
    <div class="container pt-4 pb-4">
    	<h1 class="font-weight-bold">Ducks in a ROW: Exclusive interview with Executive Vice President, Chief Operations Officer @ Aflac</h1>
    </div>
      ...
      <div class="row">
        <div class="col-lg-8">
        	<div class="text-center">
        		<img src="{{ config('app.url') }}promotions/ducks-in-a-row-image.png" class="img-fluid d-inline-block" alt="Ducks in a ROW - TEX WEEK" />   
        	</div>
          	<div class="p-3">           	        
        ...
        <div class="col-lg-4" id="company-profile">
          <div class="border border-secondary p-3 bg-light">
            ...
            <form method="post" action="{{route('texweek.success')}}">
              {{csrf_field()}}                  
