  ...
  <header>
   <nav class="navbar navbar-expand-lg navbar-light bg-white div-shadow">
    ...
    <div class="col-lg-6 text-right">
      <img src="{{ config('app.url') }}promotions/scws/scws-americas.png" height="80" class="d-inline-block" alt="TEX WEEK" />
    </div>                  
  </nav> 
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>{{session('message')}}<a href="#">info@plantautomation.com</a></p>
        <p>Sincerely,<br/>
...
<section>
 <img src="{{ config('app.url') }}promotions/scws/scws-americas-banner.jpg" class="img-fluid d-inline-block pb-4" alt="scws" />
</section>
...
<div class="col-lg-4" id="company-profile">
  <div class="border border-secondary p-3 bg-purple mt-3">
    ...
    <form method="post" action="{{route('scwsamericas.success')}}">
      {{csrf_field()}}                  
      ...
      <div class="form-group">
        <input type="text" class="form-control" name="company" id="company" placeholder="Company Name*" required value="{{old('company') }}">
      ...
      <div class="form-group">
        <input type="text" class="form-control" name="designation" id="designation" placeholder="Designation*" required value="{{old('designation') }}">
      ...
      <div class="form-group">
        <input type="text" class="form-control" name="phone" id="phone" placeholder="Telephone*" required value="{{old('phone') }}">
          @if ($errors->has('phone'))
      ...
      <div class="form-group text-center mb-0">
        <button type="submit" class="btn btn-block btn-danger mt-1 btn-radius">Submit</button>
	          	...
	          	<!-- <div class="text-center">
	          		<img src="{{ config('app.url') }}promotions/scws/seniority-attendees.jpg" class="img-fluid mb-3 mt-3" alt="scws" />
   ...
   <div class="container">
    ...
    <div class="row">
      <div class="col-lg-2 mb-2 text-center">
       <img src="{{ config('app.url') }}promotions/scws/bruce-chatterley.jpg" alt="Bruce Chatterley" class="img-fluid rounded-circle" />
       <h4 class="display-6 font-weight-bold mt-2 mb-1">Bruce Chatterley </h4>
       <p class="small">CEO, <strong>Senet</strong></p>
     </div>

     <div class="col-lg-2 mb-2 text-center">
       <img src="{{ config('app.url') }}promotions/scws/sue-monahan.jpg" alt="Kristan Kline" class="img-fluid rounded-circle" />
       <h4 class="display-6 font-weight-bold mt-2 mb-1">Sue Monahan</h4>
       <p class="small">CEO, <strong>Small Cell Forum</strong></p>
     </div>

     <div class="col-lg-2 mb-2 text-center">
       <img src="{{ config('app.url') }}promotions/scws/david-orloff.jpg" alt="David Orloff" class="img-fluid rounded-circle" />
       <h4 class="display-6 font-weight-bold mt-2 mb-1">David Orloff</h4>
       <p class="small">Chair, <strong>Small Cell Forum</strong></p>
     </div>

     <div class="col-lg-2 mb-2 text-center">
       <img src="{{ config('app.url') }}promotions/scws/mahesh-patel.jpg" alt="Mahesh Patel" class="img-fluid rounded-circle" />
       <h4 class="display-6 font-weight-bold mt-2 mb-1">Mahesh Patel</h4>
       <p class="small">IoT Director, <strong>US Cellular</strong></p>
     </div>

     <div class="col-lg-2 mb-2 text-center">
       <img src="{{ config('app.url') }}promotions/scws/michael-sherwood.jpg" alt="Michael Sherwood" class="img-fluid rounded-circle" />
     ...
     <div class="col-lg-2 mb-2 text-center">
       <img src="{{ config('app.url') }}promotions/scws/bill-stone.jpg" alt="Bill Stone" class="img-fluid rounded-circle" />
  ...
  <div class="container">
   ...
   <div class="row">
     <div class="col-lg-2 text-center">
      <img src="{{ config('app.url') }}promotions/scws/small-cell-forum-logo.png" alt="Small Cell Forum" class="img-fluid pb-4" />
    </div>
    <div class="col-lg-2 text-center">
      <img src="{{ config('app.url') }}promotions/scws/cbrs-logo.png" alt="CBRS" class="img-fluid pb-4" />
    </div>
    <div class="col-lg-2 text-center">
      <img src="{{ config('app.url') }}promotions/scws/etsi-logo.png" alt="ETSI" class="img-fluid pb-4" />
    </div>
    <div class="col-lg-2 text-center">
      <img src="{{ config('app.url') }}promotions/scws/delloro-logo.png" alt="Dell'Oro Group" class="img-fluid pb-4" />
    </div>
    <div class="col-lg-2 text-center">
      <img src="{{ config('app.url') }}promotions/scws/atis-logo.png" alt="ATIS" class="img-fluid pb-4" />
    </div>
    <div class="col-lg-2 text-center">
      <img src="{{ config('app.url') }}promotions/scws/five-g-americas-logo.png" alt="5G Americas" class="img-fluid pb-4" />
    </div>
  </div>
</div>
</section>
