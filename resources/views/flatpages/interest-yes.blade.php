...
<html lang="{{ app()->getLocale() }}">
  <head>
    <title>Interest - Yes |  Plant Automation Technology</title>
    <meta charset="utf-8">
  ...
  <body>  
    ...
    <div class="container">
      <div class="col-lg-8 offset-lg-2">
        ...
        <p>Thank you for showing interest in our services. One of our staff member will get in touch with you shortly.</p>
