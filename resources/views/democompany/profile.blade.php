...
@section('content')
  ...
  <div class="container pt-4 pb-3">
    ...
    <form name="product_form" class="product_form" method="post" id="form_count">
      ...
      <input type="hidden" name="name" value="packaging-labelling-product-enquiry">
            ...
            <div class="row">
              ...
              <div class="col-lg-2 col-md-2 col-sm-2 col-6 mb-2 text-center">
                ...
                @if($cp->company->website)
                   ...
                   <a href="{{ substr($cp->company->website,0,4) == 'http' ? $cp->company->website  : 'http://'.$cp->company->website  }}" target="_blank" class="btn btn-sm btn-outline-info btn-radius text-dark">Visit Website</a>
    ...
    <div class="row mt-4 Prod-list border bg-light" id="product"> 
      ...
      @foreach($cp->pproduct->where('active_flag',0)->where('stage',0) as $key => $cproduct) 
      ...
      <div class="col-6 col-sm-4 col-md-3 col-lg-2 mb-4">
        ...
        <div class="product div-shadow"> 
          ...
          <a href="{{url('testproducts/'.$cp->url.'/'.$cproduct->url)}}">
          ...
          <h2 class="font-12 {{$key}}">
            ...
            <a href="{{url('testproducts/'.$cp->url.'/'.$cproduct->url)}}" title="{{$cproduct->alt_tag}}"> {{ str_limit(ucfirst($cproduct->title),$limit = 40) }}
      ...
      <div class="col-6 col-sm-4 col-md-3 col-lg-2 mb-4">
        ...
        <div class="div-shadow"> 
          ...
          <a href="{{url('testproducts/'.$cp->url)}}">
