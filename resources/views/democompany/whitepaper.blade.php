            ...
            <div class="row">  
              ...
              @foreach($companyprofile as $cp)
                  ...
                  <div class="col-lg-4 mb-4">
                    ...
                    <a href="{{config('app.url').'suppliers/'.str_slug($cp->company->comp_name).'/whitepaper/'.$cp->pdf}}" target="_blank">

                       <img src="{{config('app.url').'suppliers/'.str_slug($cp->company->comp_name).'/whitepaper/'.$cp->image}}" alt="{{$cp->title}}" class="img-fluid div-scal"/>
