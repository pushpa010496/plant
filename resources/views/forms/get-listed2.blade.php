      ...
      <div class="row">        
            ...
            <tbody>
              <tr>
                <td class="bg-darkblue text-white text-center display-5 font-weight-bold">
                  <i class="fa fa-star mr-3" aria-hidden="true"></i> Free Trial <i class="fa fa-star ml-3" aria-hidden="true"></i> <span class="pull-right small">(3 Months Free)</span>
                </td>
              </tr>
              <tr>
        ...
        <div class="col-lg-5" id="company-profile">
          <div class="border border-secondary p-3 bg-light">
            <h2 class="font-weight-bold display-5 pb-1 text-center text-blue">Get Free Trial</h2>
            <form method="post" action="{{route('getlist2.basic')}}">
              {{csrf_field()}}                  
              <input type="hidden" name="member_type" value="free-trial">
      ...
      <div class="row">
        <div class="card-deck text-center">
          <div class="card text-center border border-secondary pb-4 pt-2 bg-light">
            ...
            <div class="card-body">
              <p class="card-text">"I was skeptical of the initial three months Free Trial period and what benefits i will derive out of their program, but I was really happy to see a steady stream of product enquiries and moreover from markets were we failed earlier. Their  customer success team (as they call it) is at the top of their game. Happy to recommend."</p> 
