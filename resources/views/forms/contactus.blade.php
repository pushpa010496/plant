...
@section('style')
   <style>
      .contact-bg{
        background-image: url("{{url('/industry/img/contact-us-bg.jpg')}}");
          ...
          <div class="row">  
            <div class="col-lg-6 col-sm-12 pt-4">      
                  ...
                  <form  method="post" action="{{route('contactus.post')}}">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-lg-8 col-sm-10">
                        {{Form::text('firstname', null,['required'=>'required','class'=>'form-control','pattern'=>"[A-Za-z\s]{3,30}" ,'title'=>"Enter only alphabets "])}}
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-lg-8 col-sm-10">
                        {{Form::text('lastname', null,['required'=>'required','class'=>'form-control','pattern'=>"[A-Za-z\s]{3,30}" ,'title'=>"Enter only alphabets "])}}
                ...
                <div class="form-group row">
                  ...
                  <div class="col-lg-8 col-sm-10">
                   {{Form::text('company', null,['required'=>'required','class'=>'form-control','pattern'=>"[A-Za-z0-9\s]{3,30}"])}}
                ...
                <div class="form-group row">
                  ...
                  <div class="col-lg-8 col-sm-10">
                    {{Form::text('mobile', null,['required'=>'required','class'=>'form-control','pattern'=>"[0-9\s._*#()+-]+"])}}
                ...
                <div class="form-group row">
                  ...
                  <div class="col-lg-8 col-sm-10">
                    {{Form::textarea('description', null,['rows'=>3,'required'=>'required','class'=>'form-control'])}}
                ...
                <div class="form-group row">
                  ...
                  <button type="submit" class="btn contact-btn">Submit</button>
                    {{-- <input type="button" class="btn contact-btn" value="Submit" onclick="return checkform()"> --}}
                  </div>
                </div>
                {{-- {!! Form::close() !!} --}}
              </form>
