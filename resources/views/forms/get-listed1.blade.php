            ...
            <tbody>
              <tr>
                <td class="bg-darkblue text-white text-center display-5 font-weight-bold">
                  <i class="fa fa-star mr-3" aria-hidden="true"></i> Free Trial <i class="fa fa-star ml-3" aria-hidden="true"></i> <span class="pull-right small">(6 Months Free)</span>
                </td>
              </tr>
              <tr>
        ...
        <div class="col-lg-5" id="company-profile">
          <div class="border border-secondary p-3 bg-light">
            ...
            <!-- <form method="post" action="{{route('getlist1.basic')}}"> -->
              <form name="getlisted1_form" method="post" id="form_count">
              {{csrf_field()}}   
                <input type="hidden" name="publicid" value="1f7ce1fa8e13770fdd0aa558af2e6239">
                <input type="hidden" name="name" value="plantautomation-getlisted1">               
              <input type="hidden" name="cf_leads_membertype" value="Complimentary">
              ...
              <div class="form-group text-center">
                  ...
                  <input type="button" class="btn btn-block btn-primary mt-1 btn-radius" onclick="return checkform();" value="Yes, I am interested">
              </div>
            </form>
        </div>
        </div>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form method="post" action="{{route('getlist1.basic')}}">
                  ...
                  <div class="form-group">
                      <button type="submit" class="btn btn-success mt-1" id="sub">Submit</button>
                  </div>
                </form>
              </div>
        ...
        <div id="myModal2" class="modal fade" role="dialog">
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
              <form method="post" action="{{route('getlist1.premium')}}">
            {{csrf_field()}}                  
          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              ...
              <div class="modal-footer">
               <a href="{{Request::url()}}" class="btn btn-info text-right" data-dismiss="modal">Close</a>
              </div>
            </div>
          </div>
        </div>
...
if (grecaptcha.getResponse() == ""){
 ...
 $("#verifi").html("We can't proceed request with out captcha verification!");
...
<script type="text/javascript">
      var url = "{{route('getlist1.basic')}}";
      function OnButton1(){
        document.getlisted1_form.action = url;
        document.getlisted1_form.submit();
        
        setTimeout(function(){
           document.getlisted1_form.action ="https://ochremediapvtltd1.od2.vtiger.com/modules/Webforms/capture.php";
