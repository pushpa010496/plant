      ...
      <div class="row">
        ...
        <div class="col-lg-6 form-bg-color">
          <!--  <center> @include('error')</center>    -->
            ...
            <div class="mt-4"></div>  
            {!! Form::open(['url' => 'newsletter-signup-success','class'=>'contact-form d-flex justify-content-center']) !!}
              <div class="form-container"> 
                ...
                <div class="input-container"> 
                  ...
                  <div class="row input-group req-input"> 
                    {{Form::text('company', null,['placeholder'=>"Enter Your Company name...",'required'=>'required'])}}
                  ...
                  <div class="row input-group req-input"> 
                    {{Form::text('phone', null,['placeholder'=>"Enter Your Phone Number...",'required'=>'required'])}}
                      @if ($errors->has('phone'))
                  ...
                  <div class="row input-group req-input"> 
                    {{Form::textarea('message', null,['placeholder'=>'Your Message ...','rows'=>5])}}
