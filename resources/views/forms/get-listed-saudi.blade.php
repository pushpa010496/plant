          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <ul class="error" style="list-style-type: none;"></ul>
               <form method="post"  action="{{ url(str_replace("-success", "", \Request::getRequestUri())) }}">
                <input type="hidden" name="route" value="{{ url(str_replace("-success", "", \Request::getRequestUri())) }}">
                @csrf()
                
                <input type="hidden" name="source" value="{{\Request::getRequestUri()}}">   
                <input type="hidden" name="type" value="{{ substr(\Request::getRequestUri(),1) }}">           
