...
<head>
  ...
  <meta property="og:image" content="{{ config('app.url') }}promotions/images/plant-get-listed-2.jpg" >
  <link rel="canonical" href="{{url('get-listed-campaign')}}"/>
...
<body>  
  ...
  <section>
    <img src="{{ config('app.url') }}promotions/images/getlisted-banner.jpg" alt="Plantautomation Technology" width="100%">
  </section>
    ...
    <div class="container">
      <div class="pt-4 pb-4">
        <div class="col-lg-8 offset-lg-2 font-weight-bold text-white"><legend>Sign Up - FREE</legend>
          ...
          <form action="{{url('get-listed-campaign')}}" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
