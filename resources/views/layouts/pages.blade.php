...
-->
  ...
  <style type="text/css">
   ...
   /*.table {border-color: #ccc !important;}*/
      ...
      @if(Request::url() == 'https://www.plantautomation-technology.com/newswires');
                  ...
                  <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                      <ul>
                        ...
                        <li><i class="fa fa-caret-right" aria-hidden="true"></i>&nbsp;
                          <a href="{{url('/events')}}" target="_blank">Industrial Events</a>
                        </li>
                      </ul>
                    </div>
...
<!--             <img src="{{config('app.url')}}images/pop-up.jpg" alt="Pop-Up" class="img-fluid"  /> -->
<!--        </a> -->
<!--      </div>          -->
<!--    </div>-->
<!--  </div>-->
...
<!--End welcome popup -->
  ...
  <script type="text/javascript">
    var publishUrl ="{{url('publishnews')}}"; 
  </script>
  ...
  $(function() {
    $('#productForm').submit(function(e) {
        ...
        $.ajax({
            ...
            url: "{{route('ajax-product-enquiry')}}",
            data: formData,
            success: function(data) {
               console.log(data);
               $('#enquiry').modal('hide');
