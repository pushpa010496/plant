    ...
    <!-- <div class="container-fluid">
        ...
        <div class="row fixed-top text-right bg-topbar">
            ...
            <div class="col-12 col-sm-7 col-md-4 col-lg-3 bg-purple text-center Btn-Rad-TL" id="rad_top_btn">
                ...
                <a href="{{url('/get-listed')}}" class="btn btn-sm bg-purple text-white border-0 mr-3 font-14">Get

                    Listed</a>

                <a href="{{url('/events')}}" class="btn btn-sm bg-purple text-white border-0 font-14">Industrial
                ...
                <div class=" pt-2 ">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-5 col-md-2 col-lg-2 ">
                            ...
                            <img src="{{ config('app.url') }}suppliers/{{str_slug($cp->company->comp_name)}}/{{$cp->company->comp_logo}}"

                                alt="{{$cp->company->comp_name}}" title="{{$cp->company->comp_name}}"
                        ...
                        <div class="col-11 col-sm-6 col-md-7 col-lg-5 pb-2">
                            ...
                            <h1 class="title display-5 pt-1">{{$cp->company->comp_name}}
                                ...
                                <a href="javascript:void(0)"
                                    ...
                                    onclick="trackOutboundLink('{{$cp->company->track_url}}'); return false;">
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-12 col-12 pt-2 pb-2 align-self-center">
                                ...
                                @if($cp->company->profileclaim=='pclaim')
                            ...
                            <div class="pt-1">
                                ...
                                @if($cp->company->linkedin)

                                <a href="{{$cp->company->linkedin? $cp->company->linkedin : 'javascript:void(0)'}}"

                                    target="_blank">

                                    <img src="{{ config('app.url') }}images/linkedin-img.png" alt=""
                                ...
                                @if($cp->company->twitter)

                                <a href="{{$cp->company->twitter? $cp->company->twitter : 'javascript:void(0)'}}"

                                    target="_blank">

                                    <img src="{{ config('app.url') }}images/twitter-img.png" alt=""
                                ...
                                @if($cp->company->facebook)

                                <a href="{{$cp->company->facebook? $cp->company->facebook : 'javascript:void(0)'}}"

                                    target="_blank">

                                    <img src="{{ config('app.url') }}images/facebook-img.png" alt=""
                                ...
                                @if($cp->company->instagram)

                                <a href="{{$cp->company->instagram? $cp->company->instagram : 'javascript:void(0)'}}"

                                    target="_blank">

                                    <img src="{{ config('app.url') }}images/instagram.png" alt=""
                                ...
                                @if($cp->company->youtube)

                                <a href="{{$cp->company->youtube? $cp->company->youtube : 'javascript:void(0)'}}"

                                    target="_blank">

                                    <img src="{{ config('app.url') }}images/youtube.png" alt=""
                    ...
                    <div class="collapse navbar-collapse" id="subnav">
                        ...
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item @if(\Request::segment('1')=='products') active @endif">
                                ...
                                <a class="nav-link" href="{{url('products/'.$cp->url)}}">Products</a>
                            ...
                            <li class="nav-item @if(\Request::segment('1')=='catalogue') active @endif">
                                ...
                                <a class="nav-link" href="{{url('catalogue/'.$cp->url)}}">Catalogues</a>
                            ...
                            <li class="nav-item @if(\Request::segment('1')=='pressrelease') active @endif">
                                ...
                                <a class="nav-link" href="{{url('pressrelease/'.$cp->url)}}">Press Release</a>
                            ...
                            <li class="nav-item @if(\Request::segment('1')=='whitepaper') active @endif">
                                ...
                                <a class="nav-link " href="{{url('whitepaper/'.$cp->url)}}">White Papers</a>
                            ...
                            <li class="nav-item @if(\Request::segment('1')=='video') active @endif">
                                ...
                                <a class="nav-link" href="{{url('video/'.$cp->url)}}">Videos</a>
                            ...
                            <!--  <a class="nav-link" href="{{url('project/'.$cp->url)}}">Projects</a>-->
                        ...
                        <a class="btn btn-sm btn-radius my-2 my-lg-0 pl-4 pr-4 pt-0 pb-0"
                            ...
                            href="{{url('suppliers/'.$cp->url)}}" role="button">Profile</a>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="{{route('profileclaim')}}" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 pt-4 pb-1">
                        ...
                        <a href="https://www.ochre-media.com" target="_blank" rel="nofollow">
                            ...
                            <img src="{{ config('app.url') }}/img/ochre-media-logo.png" width="70"
          ...
          <div class="modal-content p-0">           
            ...
            <div class="modal-body p-0">
              ...
              <a href="https://www.plantautomation-technology.com/promotion/sparkplug-open-specification-critical-achieving-roi-in-iiot" >
                ...
                <img src="{{config('app.url')}}images/popup-banner111.jpg" class="img-fluid border">
    ...
    <div class="modal-content p-0">           
      <div class="modal-body p-0">
        ...
        <a href="https://www.automotive-technology.com/functional-safety-usa-2023-conference" > 
             <img src="{{config('app.url')}}images/functional-safety-usa-banner11.jpg" alt="Pop-Up" class="img-fluid" /> 
        </a> 
      </div>          
    </div>
  </div>
           ...
           <button type="button" class="btn btn-default" href="{{url('events')}}">Ok</button>
                    ...
                    <div class="social-widget pt-2 text-center">
                        ...
                        <ul class="social-icons">
                            ...
                            <li>
                                ...
                                <a target="_blank" title="Facebook" class="facebook" href="{{ config('app.furl') }}"><i
      ...
      <ul class="social-icons"> -->
                            ...
                            <li><a target="_blank" title="Twitter" class="twitter" href="{{ config('app.turl') }}"><i

                                        class="fa fa-twitter"></i></a></li>



                            <li><a target="_blank" title="LinkedIn" class="linkdin" href="{{ config('app.lurl') }}"><i
                ...
                <div class="col-lg-12">
                    ...
                    <div class="copyright-section">
                        ...
                        <p class="pt-3 text-center">Copyright &copy; {!! date('Y') !!} Ochre Digi Media Pvt Ltd. All Rights Reserved.
...
<div id="enquiryModal" class="modal fade" role="dialog">
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p class="">{{Session('requiry_thank_message')}}</p>
            ...
            <div class="modal-footer">
             ...
             <a href="{{ url()->previous() }}" class="btn btn-info text-right">Close</a> 
    ...
    <script src="{{ config('app.url') }}js/jquery-ui-1.12.1.min.js"></script>
...
<script type="text/javascript">
  ...
  @if(Session::has('requiry_thank_message'))
  ...
  @endif	  	
    ...
    @if(session('thank_message') == 'I am Interested')
    ...
    @if(session('thank_message') == 'Not Interested')
    ...
    @if(session('thank_message') == 'Need more details')
    ...
    @if(session('profileclaim') == 'success')
