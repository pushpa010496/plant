...
return [
    ...
    */
    ...
    'url' => env('APP_URL', 'http://172.17.32.81/public_html'),
    'asset_url' => env('ASSET_URL', null),

    'blogurl' => env('APP_BLOG_URL', 'http://localhost'),
    
    'furl' => env('APP_F_URL', 'http://localhost'),
    'gurl' => env('APP_G_URL', 'http://localhost'),
    'turl' => env('APP_T_URL', 'http://localhost'),
    'lurl' => env('APP_L_URL', 'http://localhost'),
